  ...
  requirements: [
    ...
    },
    {
      ...
      items: [
        ...
        'THE ONLY APPLY-TIME GATE besides a Rejected CV is the Saramin one, and it is deterministic: ≥1 work experience, or (for a fresher) ≥1 education entry AND ≥1 project. The ≥3-skills clause was DROPPED 2026-09-11 — see Resume management → the qualification rule. It is enforced server-side at POST /applications, not merely greyed in the UI.',
