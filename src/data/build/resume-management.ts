        ...
        sections: [
          {
            ...
            table: {
              ...
              rows: [
                ['1 · CANDIDATE states an expected salary (onboarding step 4 / profile edit)', 'ONE figure + period + currency, or "Thỏa thuận"', '`expectedSalary { kind, currency, min, max }` — the figure goes in `min`, `max` stays NULL', 'Nobody turns down more money, so a candidate’s upper bound is noise. One number is also the lowest-friction version of the single most-skipped field on the profile.'],
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ['Candidate input', 'Jobseeker user management → Onboarding, step 4 · and Resume management → CV management (profile quick-edit)', 'The single-figure control: Từ [n] [period] [currency], plus the "Thỏa thuận" checkbox.'],
