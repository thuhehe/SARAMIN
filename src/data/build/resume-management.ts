    ...
    },
    {
      ...
      detail: {
        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              ...
              'THE AGEING ROWS ARE THE SIGNAL TO WATCH — with no timer underneath them, a row that has sat in Cần duyệt for three days is three days of a candidate’s applications not going anywhere. The age is the only thing that complains, so it has to be prominent and it has to be sortable. An unworked queue is now a candidate-facing outage, not an internal backlog.',
        ...
        states: [
          ...
          'Ageing hold — nothing releases a held CV, so the row’s age is the only thing that complains',
        ],
        backend: {
          dataModel: [
        ...
        openQuestions: [
          ...
          'BLOCKER now that the 24h net is gone: what is the review SLA, and who owns it? An unworked queue no longer leaks bad CVs to employers — it stops candidates’ applications entirely. Agree a target (hours, not days) and a staffing level before this ships, because the queue is now on the critical path of every doubtful application.',
