      ...
      detail: {
        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              'A DOUBT CV IS NOT IN THE POOL — “Not enough information” and “Can’t read” both keep a CV out of the index until an admin approves it. Unlike a held application there is NO 24h release here: the index fails CLOSED because nobody is waiting on it.',
    ...
    },
    {
      ...
      detail: {
        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              ...
              'THE 24h TIMER ONLY APPEARS ON THE APPLICATION SIDE. The index has no timer at all: a held application costs a candidate a job, a held CV costs only time, so they fail in opposite directions on purpose.',
            ],
          },
          {
            early: true,
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ...
                ['Nobody reviews within 24h', 'unchanged — still in doubt', 'auto-sent, stamped `timer`', 'still Hidden – pending review'],
        ...
        behaviors: [
          ...
          'Applying with a “chưa đủ thông tin” CV always SUCCEEDS; the application then waits for the CV verdict and auto-sends within 24h. The candidate is told at that moment — “Đang kiểm tra CV — sẽ gửi trong 24 giờ” — never warned upfront.',
          'A “không đọc được nội dung” CV HOLDS like any other doubt — its applications sit Pending and auto-send within 24h, and it stays out of CV search until an admin approves it. (This reverses an earlier draft in which it sent normally: doubt has to behave like doubt on both surfaces, and the 24h net is what stops the hold ever costing a candidate a deadline.)',
        ...
        rules: [
          ...
          'An uploaded CV below the rule may ALWAYS be attached to an application — the apply itself is never refused. What waits is DELIVERY, and it waits at most 24h.',
          ...
          'Index holds never auto-pass; application holds ALWAYS auto-send at 24h. Neither default may be changed without changing this page.',
        ...
        states: [
          ...
          'Doubt (Not enough information · Can’t read) — Hidden – pending review, applications Pending on the 24h net',
          'Rejected — Hidden, applications Not sent',
          'Auto-sent at 24h — application delivered, CV still held and unindexed',
          ...
          'Ageing hold — no timer on the queue, so the row’s age is the only thing that complains',
        ],
        backend: {
          dataModel: [
          ...
          endpoints: [
            ...
            'Scheduled job — releases applications held longer than 24h, stamping holdReleasedBy = timer. It never touches cv.qualifyStatus',
          ],
          integrations: [
        ...
        acceptance: [
          ...
          'No application waits longer than 24h, whether or not anyone reviews it.',
