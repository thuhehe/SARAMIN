  ...
  requirements: [
    {
      ...
      text: 'UPDATED 2026-09-16: the Admin “Create resume” page is REMOVED — HQ does not create CVs on a candidate’s behalf — so the module is now FOUR screens and four Logic pages; the label keeps its old wording so shared links still land. Rewritten 2026-08-13: the earlier version listed five surfaces and had fallen behind the module, which now also carries four LOGIC pages. A Logic page is not a screen — it is one rule several screens must agree on, written once so the same decision is not re-made per screen.',
      table: {
      ...
      items: [
        ...
        'LOGIC · Recommended jobs (matched to a jobseeker) and Relevant jobs (matched to another job) are two DIFFERENT calculations, and both reuse existing data rather than defining a new score. → [Recommended jobs](/m/job-management/recommended-jobs-matched-to-a-jobseeker-s-profile) · [Relevant jobs](/m/job-management/relevant-jobs-matched-to-another-job)',
      ],
    ...
    },
    {
      ...
      items: [
        ...
        'HQ does NOT create CVs on a candidate’s behalf — the Admin “Create resume” page was removed on 2026-09-16 (client review). Both routes belong to the jobseeker; who created a CV is an audit fact, never a behavioural difference.',
        'The “Saramin Standard Resume” (`standardJson` — the CV-content sections plus preferences and tags) is the RENDERED CONTRACT: the shape a Saramin CV is serialised to and read back in. It is not a third storage location — identity and preferences resolve from the Profile, career content from the CV record. Its section list is the Create CV builder’s — [Create CV](/m/resume-management/create-cv) → UI fields → “Builder — sections” — with identity and preferences from the two Profile tables below.',
    ...
    },
    {
      ...
      items: [
        ...
        'Exactly ONE CV is the searchable/main CV at any time — that flag gates the EMPLOYER index only. The other CVs are still applied with, and the jobseeker’s own recommendation feed reads EVERY CV (see [Recommended jobs](/m/job-management/recommended-jobs-matched-to-a-jobseeker-s-profile)), so “not searchable” never means “ignored”.',
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          ['6 · Save', 'A live COUNT above the field (“12 kỹ năng”), not a quota — nothing blocks and nothing turns red. Past 25 an amber note says the score starts to dilute, and the candidate may still add more. Under 3, an amber note names the shortfall and counts it down, because THAT floor really does block.', 'Stored as CvSkill rows: skillId only. **NO CAP on the number of skills per CV** (decided 2026-09-02). No years, no featured flag, no ordering weight.'],
      ...
      items: [
        ...
        '★ NO CAP ON CV SKILLS (DECIDED 2026-09-02), and the defence moved into the SCORE instead. A cap of 20 was specified and built, then removed for a practical reason that outweighed the theory: an uploaded PDF can legitimately carry more than 20, extraction cannot be told to stop finding them, and enforcing our limit inside the confirm screen of somebody else’s document is the wrong place to hold the line. THE JOB SIDE KEEPS ITS CAP OF 10 — the asymmetry is deliberate, because a job’s list is a REQUIREMENT SET that has to stay tight to mean anything, while a CV’s list is a DESCRIPTION of a person and capping it caps what they may say about themselves.',
        'WHAT PROTECTS THE SCORE NOW — three things, none of which blocks anybody. ① THE POINT CAP: 1 point per matched skill, **capped at 4** (weights v4, 2026-09-19), so a CV listing every row in the taxonomy earns exactly what a CV matching 4 does. Stuffing buys a tie at the ceiling, never a win. ② THE CEILING IS LOW (4 skills), so on a job listing fewer than 4 skills stuffing gains literally nothing — nobody reaches the cap. ③ THE BREADTH DISCOUNT: past 25 skills on one CV the skills score is multiplied by `25 ÷ total`, so 50 skills halves it and 100 quarters it. A real CV holds 10–15, so the rule is invisible to everyone honest.',
        'THE DISCOUNT IS DISCLOSED, NOT HIDDEN. Past 25 the field says so — “hồ sơ tập trung được chấm cao hơn, từ kỹ năng thứ 26 điểm bắt đầu giảm” — and still lets them add more. A silent penalty is indistinguishable from a bug to the person it happens to, and a candidate who cannot see the rule cannot follow it.',
        'MEASURE THE DISTRIBUTION, and expect to move the 25. Track p50/p95/p99 of skills-per-CV. If p99 climbs toward 25 the threshold has become a target and it should come DOWN, not up — the same rule the old cap carried, and the reason a soft threshold is safer than a hard one: lowering it degrades scores gradually instead of invalidating CVs people already saved.',
        'PHASE 2 REPLACES ALL OF IT WITH EVIDENCE. Weight a matched skill by whether it appears in the candidate’s work-experience text — evidenced skills full, merely-declared skills less. Then breadth costs nothing and stuffing is pointless by construction, because claiming a skill stops being free. It waits on extraction being trustworthy, which is the same blocker as the ESSENTIAL-skill weighting.',
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ['Skills', '4', '**4 or more** of the job’s skills are on the CV. The rule is one line: **1 point per matched skill, capped at 4.** Held this low since 2026-09-19 because the skill master data is not ready — see “WHY THE WEIGHT IS 4” below.', 'Fewer than 4 matched → 1 point each. Two matched → 2.', 'No overlap at all — or the CV yielded no skills we could read, in which case the block is DROPPED and renormalised rather than scored zero.'],
          ['Years of experience + career level', '28', 'Candidate years fall inside the job’s stated range and the level agrees.', 'Under the minimum → 28 × (years ÷ min). Over the maximum → 28 − 2 per year over, floor 14; over-qualified is still a real candidate.', 'Zero years against a role with a stated minimum.'],
          ['Location + work type', '26', 'The job is remote and the candidate accepts remote (city is then irrelevant) — OR a desired location contains the job’s location and the candidate accepts the job’s work type.', '18 for an adjacent province in the same region · 15 for a city miss where the candidate will relocate · 9 for a city hit where the work type is wrong (remote-only candidate, in-office job).', 'No location overlap, no relocation, and no work-type overlap.'],
          ['Desired job role + category', '23', 'The job’s `job_role` IS the candidate’s desired role — an exact id match, both sides having resolved to the same master row.', '12 when the CATEGORY matches but the role does not · 5 for a sibling category in the same group.', 'Unrelated category.'],
          ['Expected salary', '9', 'The candidate’s ONE expected figure falls inside the job’s salary band, SAME CURRENCY — or the candidate’s salary is INTERVIEW / unset — or the two sides are in DIFFERENT currencies (scored neutral, see below). The candidate states a single number, the job states a band; there is no second candidate number, so this is a point-in-range test.', '4 when the candidate’s figure is within 20% above the job’s maximum, same currency.', 'Candidate’s figure exceeds the job maximum by more than 20%, same currency.'],
      ...
      items: [
        ...
        'MISSING CANDIDATE DATA — and the distinction matters, because getting it wrong turns the score into a measure of form-filling. CONSTRAINT signals (salary, employment type, education, mobility) score NEUTRAL when the candidate is silent: silence means "no constraint", and punishing it would rank the fussy above the flexible. EVIDENCE signals (skills, years) score LOW when the CANDIDATE left them out: that silence really does mean "no evidence". But see the next rule — silence we CAUSED is a different thing entirely, and the two used to be conflated here.',
        '★ A PARSER FAILURE MUST NOT COST THE CANDIDATE THE SKILLS BLOCK (REVISED 2026-09-02, and this reverses the previous rule). The old rule said a CV yielding no CvSkill rows forfeits the skills block and caps at 62, calling it honest because “silence means no evidence”. It is not honest when the silence is OURS. Extraction is currently unreliable and the skill taxonomy is still thin, so an empty skill list is far more often our failure to read a document than a candidate’s failure to have skills — and this very module already holds the opposite principle for exactly this reason: “a failure may be OUR parser, not the document”, which is why a doubtful CV is held for review rather than refused. The two rules contradicted each other, and the candidate lost.',
        'SO: WHEN A CV YIELDS NO READABLE SKILLS, THE SKILLS BLOCK IS DROPPED AND RENORMALISED — its 4 points are redistributed proportionally across the seven signals that remain, exactly as the RENORMALISE RULE already does for a job that states no requirement. The candidate is then ranked on what we CAN read (years, level, location, category, salary, industry, education, language) instead of being pushed to the bottom for a document we could not open. It needs no new data and no better taxonomy, which is why it ships first.',
        'THE NUMBERS THAT DECIDE WHETHER 4 IS STILL RIGHT — the share of CVs that yield ≥ 3 readable skills (split by route, typed vs uploaded) and taxonomy coverage by role, with aliases. This weight was cut from 38 to 20 on 2026-09-02 and from 20 to 4 on 2026-09-19 on exactly this kind of measurement; it moves again, in either direction, on the same evidence. Years + level (28), Location + work type (26) and Role + category (23) now carry the model, and that ordering is itself a statement about which data we currently trust.',
        ...
        '★ DESIRED ROLE WAS COLLECTED BUT NEVER SCORED (FIXED 2026-09-02). Work preference holds SIX fields; this table scored five of them. `desiredJobRole` was asked at onboarding, stored, and used to suggest skills — and then ignored by the one calculation that decides what a candidate is shown. The DIRECTION half of the model was running at its coarsest resolution: a candidate who asked for **UX Designer** scored the full 10 on an **Interior Designer** posting, because both sit under the Design category. Two jobs, one of them exactly what they asked for and one they have never thought about, indistinguishable.',
        'IT COSTS NOTHING TO FIX, WHICH IS WHY THERE IS NO EXCUSE FOR THE GAP. Both sides already store a RESOLVED role id — the candidate picked from a dropdown, the job carries `job_role` — so the comparison is an id match, exact and language-independent. No new table, no new field, no migration. The 10 points are not increased either: the same weight is simply graded by how precisely the two agree (role → 10, category only → 5, sibling category → 2), so the rest of the table does not move.',
        'DEFERRED — THE “NEARBY ROLE” TIER (UX Designer ↔ Product Designer, Backend ↔ Fullstack). It is the obviously missing middle, and it needs a role-family relation that does NOT exist in the schema today; `job_role_alias` resolves spellings of the SAME role and cannot express adjacency. Adding a tier that reads a table we do not have is the same mistake as the ESSENTIAL-skill denominator above, so it waits for the data. Until then a near-miss role falls to the category tier, which is the honest place for it.',
        '★ THE DENOMINATOR WAS COUNTING THE WRONG THING (REVISED 2026-09-02). The skills block used to score `matched job skills ÷ ALL job skills`. That is safe in one direction and wrong in the other, and the reason is only visible once you notice WHAT is being ranked. Ranking CANDIDATES for one job, the denominator is the same for everybody, so it just scales every score and the order is untouched. Ranking JOBS for one candidate, the denominator CHANGES from row to row — so a job that describes itself carefully is punished for it. Worked example, one candidate with React · TypeScript · Node · CSS · Figma: a job listing 3 skills they match all of scored 3⁄3 of the block, while a job listing 12 of which they match 5 scored only 5⁄12 of it. The second job uses MORE of this person and lost heavily. The feed was systematically recommending vague postings over well-written ones.',
        'THE FIX: COUNT THE MATCHES, CAP THE COUNT — **1 point per matched skill, capped at 4** (since 2026-09-19; 5 per skill capped at 20 from 2026-09-02). It is a saturating count rather than a ratio against the job’s own list, so a job that describes itself carefully is no longer punished for it: the same two jobs now score 3 and 4, and the better-specified one wins. One formula still serves both directions, so a CV × job pair yields ONE number no matter who is looking; splitting it per direction was considered and rejected, because an employer and a candidate seeing different percentages for the same pair is a support call nobody can answer.',
        '★ WHY THE WEIGHT IS 4 AND THE CAP IS 4 SKILLS (REVISED 2026-09-19 — it was 38 points and 8 skills for one day, then 20 points and 4 skills from 2026-09-02, and the state of the master data cut it again). Extraction currently returns 3–5 skills from a typical CV, so a realistic MATCH is about 2. A cap of 8 was therefore unreachable: every candidate would have scored a quarter of the block, the signal would have stopped separating anybody, and it would have dragged every total score down with it. A weight must fit the range its data actually produces. With the cap at 4, a typical 2-skill match earns half the block — which is where a signal discriminates.',
        'AND THE TAXONOMY ONLY COVERS 5 OF 21 CATEGORIES, which is the other half of the argument. For a candidate outside IT, Marketing, Design, HR and Planning there are no skill rows to match at all, so the block renormalises away and the other seven signals carry the whole score. A 38-point weight on a field that does not exist for most of the market was never defensible; 20 assumed the taxonomy would be filled by launch, and it has not been — 731 rows, zero aliases, job titles and typos still in the list. 4 is what the data supports today: enough to keep the signal alive and measurable, too small to punish anyone for our gaps.',
        'RAISE IT BACK WHEN THE DATA EARNS IT. This weight is pinned to a measurement, not to an opinion — track skills extracted per CV and matched-skills per scored pair. If extraction climbs to 8–10 skills per CV and the taxonomy covers most categories, raise the cap and the weight together; the cap should sit near the 75th percentile of matched skills, never above it. The concrete trigger for the first step back to 20: skills authored for ~70% of roles WITH aliases, and a median of 5+ readable skills per uploaded CV — both read off the Matching report and the unmatched-term queue, not off anyone’s impression.',
        'UNBOUNDED COUNT WAS REJECTED, and the distinction is the whole design. Scoring the raw number of matched skills with no ceiling would let a job listing 30 skills outrank every well-written posting in everyone’s feed, and would make scores incomparable between postings. The CEILING is what makes counting safe: a padded job reaches the same 4 a well-specified job reaches, and never more.',
        'DEFERRED TO PHASE 2 — weighting the numerator by ESSENTIAL vs OPTIONAL (`occupation_skill`, essential ×2). It is the better model and it was the first fix proposed, then set aside on 2026-09-02 for one reason: it depends on `occupation_skill` being densely populated, and the skill master data is currently thin. A formula that reads data we do not have is worse than a blunt one that reads data we do. Revisit when the taxonomy is real — the change is numerator-only, so nothing else in this table moves.',
        'WHERE THE 100 POINTS COME FROM — worth knowing before anyone proposes a “CV-only” recommender. CV CONTENT = 22 (skills 20 + language 2). WORK PREFERENCE = 53 (location + work type 21, desired role + category 18, salary 9, industry 5). BASIC INFORMATION = 3 (education level, and that is all). SHARED = 22 (years + career level). Drop CV content and you recommend jobs the candidate wants but cannot get; drop Work preference and you recommend jobs they could do but do not want. Neither half is optional.',
        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              ...
              'SKILLS ARE A NUDGE HERE, NOT A GATE. They left the qualification rule on 2026-09-11 (thin master data); they are a minor match weight now (4 of 100 since 2026-09-19 — the taxonomy is not ready) but still the main CV-search FILTER, so both the ready-state rail and the ready-state sheet end with the same line: “Thêm kỹ năng để NTD dễ tìm thấy bạn hơn — đó là tiêu chí họ lọc nhiều nhất.” Promise of reach, never threat of refusal.',
          ...
          },
          {
            ...
            text: 'The rail names the rule, but a candidate scrolling a twelve-section form still has to map “one of the two” onto section headers. Decided 2026-09-11 (approved as “1 + 2”; built in Figma frame 3030:24396 “Create Saramin CV”, with a three-state board beside it): the sections the rule reads carry a tag that changes as the candidate types, and their empty-state placeholders spell out the other path. The “Fresher / Experienced” self-declaration that used to switch the required marks is gone.\n\nSIMPLIFIED 2026-09-25 when projects left the rule: **TWO tagged sections, not three**, and the second branch is a single entry rather than an AND. Highlight projects is no longer part of the gate, so it loses its tag and its placeholder stops promising to stand in for experience.\n\nEverything below is a RENDERING of the same derived state the rail shows — see “ONE EVALUATION OF THE LOGIC, MANY RENDERINGS” above. Nothing here is typed by hand.',
            table: {
              cols: ['Surface', 'Copy (EN frame · VN build)', 'How it reacts'],
              rows: [
                ['**Section tag — Work experience**', '`Add at least 1` · “Thêm ít nhất 1”', 'Amber while the CV has neither a work entry nor an education entry. Turns green `✓ Done` (“✓ Đã có”) on the first work entry. LEAVES entirely once an education entry exists — the branch is no longer needed.'],
                ['**Section tag — Education**', '`Or: Education` · “Hoặc: Học vấn”', 'Mirror of the Work experience tag. Amber while neither exists, `✓ Done` on the first education entry, and LEAVES the moment a work entry is added. The two tags render the same OR, so they always agree.'],
                ['**Section tag — Highlight projects**', '**CUT 2026-09-25** — no tag', 'Projects left the rule, so the section joins the untagged majority. A tag on a section that gates nothing is the decoration the rule below warns about.'],
                ['**Placeholder — Work experience**', '“Add at least one role, internship or paid job. Never worked? An Education entry works instead.” · “Thêm ít nhất một vị trí, kỳ thực tập hoặc công việc có lương. Chưa đi làm bao giờ? Chỉ cần điền Học vấn là đủ.”', 'Static. A placeholder is read BEFORE anything is typed, so it carries the other path in full; the tag does the reacting.'],
                ['**Placeholder — Education**', '“…If you have no work experience, this stands in for it.” · “…Nếu chưa có kinh nghiệm làm việc, mục này thay cho kinh nghiệm.”', 'Static.'],
                ['**Placeholder — Highlight projects**', '“Describe a project you did — an outcome beats a description.” · “Mô tả một dự án bạn đã làm — kết quả đáng giá hơn mô tả.”', 'Static. The “stands in for experience” half was REMOVED 2026-09-25 — it would now be a false promise.'],
            ...
            items: [
              'THE BOARD SHOWS THREE END STATES, and after 2026-09-25 there is no longer a half-finished one. ① EMPTY CV → both tags amber (Add at least 1 · Or: Education), rail “Not ready yet”. ② ONE WORK ENTRY → Work experience `✓ Done`, Education carries NO tag, rail “Ready”. ③ NEVER WORKED, one education entry → Education `✓ Done`, Work experience carries NO tag, rail “Ready”. The old in-between state — one half of the second branch filled, rail still “Not ready yet” — is GONE, because the branch no longer has halves. A satisfied OR has no remaining obligations, which is why the other tag leaves rather than fades.',
              'NO FRESHER / EXPERIENCED SWITCH (dropped 2026-09-11, still true). The builder shipped with a “Bạn là… Fresher / Experienced” dropdown that changed which sections were marked required. It asked the candidate to classify themselves before typing anything, it created a second source of truth (a self-declared persona beside what the CV actually contains), and the OR-rule already serves both people without a question. The form reads the entries, never an answer about the entries.',
              'ONLY THE SECTIONS IN THE RULE EVER CARRY A TAG — now two, not three. Highlight projects, Skills, Foreign languages, Certificates, Awards, Activities, References and About stay untagged: a “Recommended” tag that sits still on every visit is decoration, and it dilutes the ones that matter. Skills keep their nudge in the rail and the post-save sheet, not on the header.',
              ...
              'WHY NOT ASTERISKS. A * on Work experience says “mandatory” to the student who has none; a * on Education says “mandatory” to the foreman who never filled it in. Neither is true under an OR. A tag with a verb (“Add at least 1”, “Or: Education”) can say what an asterisk cannot.',
            ],
          },
          {
    ...
    //    Authored as a research/discovery brief because we have no data model yet.
    {
      ...
      detail: {
        ...
        sections: [
          {
            early: true,
            heading: 'THREE ACCESS TIERS — the row, the opened CV, and the unlocked CV',
            text: 'The commercial design of the whole feature sits in this one table, and since 2026-08-23 it has THREE gates rather than two: no package → the CV cannot be opened at all, only the result row; a package → the CV opens with contact details masked; an unlock credit → everything.\n\nThe line we draw is a purpose, not a field list: tier 2 must let an employer JUDGE a candidate without being able to REACH them. Everything describing FIT is included in the package; everything that leads to CONTACT is paid for per candidate.',
            table: {
              ...
              rows: [
                ...
                ['Ngày sinh', 'Ẩn — chỉ hiện tuổi', '**Hiện** (quyết định 2026-08-23)', 'Hiện'],
                ['Số năm kinh nghiệm', 'Hiện', 'Hiện', 'Hiện'],
                ['Công việc hiện tại — công ty, chức danh, thời gian', 'Hiện, **tên công ty che** thành loại hình + thành phố. Thời gian còn mở (“– nay”) nghĩa là đang đi làm', '**Nêu đúng tên công ty**', 'Đầy đủ'],
                ['Công việc hiện tại — mô tả', 'Hiện, gói trong MỘT dòng', 'Đầy đủ', 'Đầy đủ'],
                ['Các công việc trước', 'Chữ ngắn — công ty · chức danh (tổng thời gian), tên công ty che. Dư ra hiện “+N”', 'Toàn bộ, có mốc thời gian và mô tả', 'Đầy đủ'],
                ['Học vấn', 'Chỉ mục mới nhất', 'Toàn bộ', 'Toàn bộ'],
                ['Kỹ năng', 'Vài kỹ năng đầu + “+N more”', 'Toàn bộ', 'Toàn bộ'],
                ['Ngoại ngữ · chứng chỉ · dự án · giải thưởng · hoạt động', 'Ẩn', '**Hiện** — trừ link và mã chứng chỉ (xem dưới)', 'Đầy đủ'],
                ['Nơi làm việc · lương mong muốn · thời gian có thể đi làm · cập nhật lần cuối', 'Hiện', 'Hiện', 'Hiện'],
                ['Số điện thoại', 'Ẩn', '`090• ••• •••`', '**Đầy đủ**'],
                ['Email', 'Ẩn', '`m••••@gmail.com` — giữ tên miền', '**Đầy đủ**'],
                ['Link portfolio · website · mạng xã hội (LinkedIn · Facebook · GitHub · Behance…)', 'Ẩn', '`🔗 Portfolio — mở khoá để xem`: biết là CÓ, không biết ở đâu', '**Link thật, bấm được**'],
                ['Link dự án', 'Ẩn', 'Tên và mô tả dự án **hiện**; chỉ link bị che', '**Link thật**'],
                ['Mã / URL chứng chỉ', 'Ẩn', 'Tên · nơi cấp · ngày **hiện**; chỉ mã và URL bị che', '**Đầy đủ**'],
                ['**Người tham chiếu (References)**', 'Ẩn', '**Ẩn cả khối**', 'Hiện'],
                ['**File CV gốc (PDF)**', 'Ẩn — không preview, không thumbnail', '**✕ — chỉ xem bản dựng lại đã che, không có file gốc**', '**Xem và tải xuống**'],
              ],
            },
            items: [
              ...
              'MASK SERVER-SIDE, NEVER IN THE CLIENT. The tier-2 endpoint must not return the real name, phone, email or any URL at all — not hidden with CSS, not sitting in a JSON the page never renders. A masked field that ships to the browser is not masked; it is one devtools tab away from being free.',
              'PHOTO AND DATE OF BIRTH ARE SHOWN AT TIER 2 (client decision, 2026-08-23), recorded with its cost so the trade is not rediscovered later: both are identity resolvers the tiering does not close, and both are also what a recruiter reads when deciding whether to spend a credit — so hiding them would cost conversion. The residual risk and its mitigations are NOT re-argued here; **“Re-identification — the risk this field set creates”**, below, owns that question for the whole feature.',
              'THE REFERENCES BLOCK IS THIRD-PARTY DATA, and the only section hidden in full at tier 2. The people named in it never signed up, never consented to a CV pool, and their phone numbers are exactly as contactable as the candidate’s. It also stays out of the keyword index at every tier.',
              'ONE UNLOCK = ONE CANDIDATE, FOREVER. Re-opening an unlocked CV is free and never a second charge — the credit buys the person, not the page view. Charging twice is the fastest way to teach recruiters to screenshot everything on first open.',
              '★ AN UNLOCKED CV IS LIVE, NOT FROZEN — the candidate edits it, and the employer who unlocked it sees the NEW version (decided 2026-08-23). This follows from the line above rather than being a separate choice: if the credit buys the PERSON, it buys their current CV. The rule that separates this from an application is simple enough to carry in one sentence — **AN EVENT IS SNAPSHOTTED, ACCESS IS LIVE.** An application is an event (“you sent me this, on this date”), so it freezes and must stay provable. An unlock is access (“I can see this person”), and access to a stale document is worth less to both sides: the employer contacts them about a job they left, the candidate is judged on a CV they have since improved.',
              'THE SAME INSTINCT IS ALREADY IN THE APPLICATION RULES, which is the best evidence this is right: a snapshotted application still resolves CONTACT DETAILS live, because a candidate who changes their number must become reachable on the new one. The frozen thing is the document as evidence; the live thing is anything that answers “can I still act on this?”.',
              'SHOW “CẬP NHẬT LẦN CUỐI” ON AN UNLOCKED ROW, and flag a change since the unlock. A refreshed CV is one of the strongest signals a recruiter can get — it means the candidate is actively looking again — and it costs nothing to surface on a list they already own. Silence wastes it.',
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ['**1 · GATE** — binary', 'Who is eligible at all', '**“WHO IS IN THE POOL AT ALL”**, below. Never gate on a domain field (salary, years): each can empty the result set and none can explain why.'],
                ['**2 · FILTER** — binary', 'The rail facets the recruiter ticked', '**“Every filter, and the field it reads”**, below. OR within a facet, AND across. The keyword is NOT a filter — it feeds stage 3.'],
                ['**3 · RANK**', 'Orders the survivors', 'Which fields, and how much each counts: **“KEYWORD SEARCH”**, below — one table, one answer. The CV-side ranking rules are the items here.'],
                ['**4 · TIE-BREAK**', 'Breaks equal scores deterministically', '`lastUpdatedAt` → completeness → `cvId`. Specified here, because nowhere else owns it. No randomness anywhere, so pagination is stable.'],
              ],
            },
            items: [
              '★ NO PAID BOOST IN CV SEARCH — the one place this model parts from job search, where the posting tier BANDS the results (Top Job first, then Distinction, then Basic Plus, then Basic, then Free). Nobody pays on the candidate side, so a boost would mean WE decide which people surface for reasons unrelated to the query. A recruiter who has bought the pool is paying for relevance; selling them sponsored candidates on top is the fastest way to lose trust in a paid search product. No bands, no floor, no tier — a candidate has no tier to band BY.',
              'NO MATCH SCORE IN THE KEYWORD BOX, mirroring the same ban on the job side. Typing “điều dưỡng” returns nurses, ranked by how well they answer that word — not by fit against a job the recruiter happens to have open. “Find candidates for THIS job” is a different entry point with its own screen, exactly as recommendations stay out of job search. Blending them makes “why is this person here?” unanswerable from the query.',
          ...
          {
            early: true,
            heading: 'KEYWORD SEARCH — which fields it reads, and how much each one counts',
            text: 'Candidate data is three groups and the keyword box does not treat them alike: it reads NONE of Basic information, reaches Work preference only through master-data resolution, and does its text work entirely inside CV content.\n\nTWO QUESTIONS, ONE TABLE (merged 2026-08-23). “Is this field read at all?” and “how much does it count when it is?” were briefly two sections, which is two places for one answer to drift. The WEIGHT column carries the second question: 1 is the strongest signal, 9 the weakest, — means the field is not read.',
            table: {
              cols: ['Group', 'Field', 'Read?', 'Weight'],
              rows: [
                ...
                ['1 · Basic information', 'References — name · phone · email of a THIRD PARTY', '❌ NEVER, at any tier. Those people never signed up and never consented to the pool; indexed, the block also makes a REFEREE findable through someone else’s CV.', '—'],
                ['2 · Work preference', 'Desired role · category · industry · location · work type', '✅ YES — through resolution, which is the NORMAL case, not an edge. These fields hold ids, not sentences (the candidate picked from a dropdown), so there is no text to scan; instead the typed term is resolved against master data first, and a hit compares ids. Worked example: candidate picks desired role “UX Designer” → we store the role id; recruiter types “ux designer” → resolves to the same id → FOUND (and cross-language: “thiết kế UX” with an alias finds it too). The only miss is a term resolution cannot map — “ux desginer” with no alias reaches no id, and there is no text here to fuzzy-match against.', '**4** — wanting a role is real but weaker than already being in it'],
                ['2 · Work preference', 'Expected salary', '❌ A number. Rail only.', '—'],
                ['3 · CV content', 'Headline / current title', '✅ TEXT. Free text — there is no Title taxonomy — so it is analysed text, never a tag.', '**1** — the candidate’s own answer to “what am I”'],
                ['3 · CV content', 'Skills · language + level', '✅ Both ways — the resolved id (cross-language), and the words as written on the CV (text).', '**2** — a master-data join; the only signal prose cannot match by accident'],
                ['3 · CV content', 'Work-history job TITLES', '✅ TEXT, language-bound.', '**3** — proof they have done it, not just want to'],
                ['3 · CV content', 'Employer names — current and prior', '✅ TEXT, language-bound.', '**5** — “ai từng làm ở Vinmec”'],
                ['3 · CV content', 'School · major', '✅ TEXT.', '**6**'],
                ['3 · CV content', 'Certificate · project · award NAMES', '✅ TEXT — names only. The credential code and project URL are masked at tier 2 and indexed at no tier.', '**7**'],
                ['3 · CV content', 'About / summary', '✅ TEXT, language-bound.', '**8**'],
                ['3 · CV content', 'Work-history DESCRIPTIONS', '✅ TEXT — the largest surface, and the loosest.', '**9 — last, deliberately.** See below'],
              ],
            },
            items: [
              ...
              'THE PII RULE IS THE POINT of the first rows, and it is not in any earlier section: excluding name, email and phone from the index is what makes the masked row honest. If the text index contained them, SEARCH ITSELF WOULD UNMASK — no unlock needed, no audit line written. Masking a name on screen while still matching it means typing a name and reading the answer off the result count.',
              '★ WHY THE BODY IS LAST (weight 9), and the failure it prevents: a QA engineer whose description reads “worked closely with designers” must never outrank an actual Designer. Flat matching is precisely how that happens, and it is the commonest way a keyword search comes to feel broken while every individual match is technically correct.',
              'ROLE IS THE WEAKEST-BACKED HIGH-VALUE FIELD, and the one to invest in. With no Title taxonomy, weights 1 and 3 are both plain text: “điều dưỡng” will not find a CV that says “y tá”, and “kế toán trưởng” will not find “trưởng phòng kế toán”. Either an alias list or an analysed/fuzzy index is needed before launch — a Phase-1 decision, not a tuning detail.',
              'SEARCH THE LIVE CV, NEVER THE APPLICATION SNAPSHOT. Snapshots exist so an employer keeps what was actually sent to them; search answers who is available NOW. Indexing snapshots returns people on the strength of a CV they have since replaced.',
          ...
          {
            heading: 'CV detail — the right rail (Activity), built only from records we already keep',
            text: 'Saramin Korea’s CV detail carries a 420px rail with Feed (interviews · aptitude tests · emails sent) and two note boards. None of those objects exist in Phase 1 — no scheduling, no tests, no employer→candidate messaging — so the rail is rebuilt from four things the model does record. Figma: https://www.figma.com/design/ljutPxIbZWjbmpaZfSyeBN/Saramin?node-id=2378-61531',
            table: {
              cols: ['Card', 'Shows', 'Source'],
              rows: [
                ['Counters strip', 'Applied to your jobs · In your pipelines · Unlocked (date or —)', 'Application management · pipeline membership · unlock audit'],
                ['Access & unlock', 'Tier chip (Contact masked · Unlocked) · which package opened it · masked phone / email / “🔗 N links” · CV file rule (structured view; original PDF after unlock) · “Unlock · 1 credit · 41 of 200 left · pack ends dd/mm” · who unlocked, when · the two rules: one unlock = the candidate for good, the CV is live', 'The three access tiers · CV pack activation (Products) · unlock audit'],
                ['Why this candidate matched', 'The result row’s band and reason line, carried onto the detail: role ✓ · skills n of N (naming the missing ones) · location ✓ · salary rule (negotiable passes any range)', 'Result tiers — every row says WHY'],
                ['Fit to your open jobs', 'Up to 3 open jobs with the match % and its two contributing signals; below the relevance floor the job reads “Related” with no number; {{btn:Add to pipeline}} per job; “See all N open jobs”', 'Match score — one formula both directions · Relevance floor'],
                ['History with your company — the rail’s first tab (designed 2026-09-06, Figma node 2433-14269)', 'Summary strip (applications · saved for a job · unlocked date). **Applications to your jobs**: one card per application — job · stage chip · a 5-segment pipeline stepper New → Reviewing → Shortlisted → Interview → Hired (Rejected greys the card, kept as history) · applied date · CV version sent (snapshot) · who moved it and days in stage · Open application · Move stage. **Saved for positions**: job · Not contacted / Contacted · saved by whom, when, from which search · the note · Open job · Add to pipeline · Remove; “Save candidate” saves to a job or to the general shortlist. **Views & unlocks**: timeline of views (who, which search) and the unlock (who, credit, pack) · “CV last updated dd/mm (v.n)” with an “Updated since your last view” variant · flags when they apply: Recalled by Saramin (credit refunded) · Tài khoản không còn tồn tại (no refund) · CV hidden from search (your unlocked copy stays). Footer: company-only scope, audited.', 'Application management (stage, snapshot, actor) · SavedCandidate (NEW — see items) · audit log (PII actions) · CV qualification (recall) · Delete account'],
              ],
            },
            items: [
              'REVISED 2026-09-06 (Thu): the rail LEADS with the **CV Search product panel** (next section) and the KR tabs are gone — the Activity cards follow the panel under a quiet “About this candidate” heading. Team notes on a candidate remain a PROPOSAL, not drawn: if approved, CandidateNote { accountId, jobseekerId, authorUserId, body, visibility team | private, createdAt }, readable by roles with “View applications & CVs”, following the candidate into every job’s applicant detail.',
              'Dropped from KR on purpose: Interview and Aptitude-test cards (no scheduling or tests in Phase 1 — Interview is a stage chip in History), Sent-emails history (contact is off-platform after unlock), and the 지원 · 제안 · 저장 counters (no proposal feature; “Save candidate” is not specced — our equivalent action is Add to a job pipeline).',
              'The rail never shows a bare match number and never shows real contact data below tier 3 — both rules are the same ones the result row and the header obey.',
              'SAVED CANDIDATES IS NEW DATA (the header’s “Save candidate” had nothing behind it): SavedCandidate { accountId, jobseekerId, jobId?, savedByUserId, savedAt, note?, contactedAt? } — one row per (candidate, job), jobId null = the general shortlist. Readable by roles with “View applications & CVs”; Remove is by the saver or an Admin. It is a shortlist, not a pipeline entry: “Add to pipeline” converts it into a sourced application row on that job (stage New, source = CV search) — that conversion needs a line in Application management before build.',
              'EMPTY STATES, one sentence each: “No applications to your jobs yet” · “Not saved for any position — use Save candidate in the header” · “Nobody on your team has viewed this CV before” — never an empty box.',
              'ORDER: newest first inside each card; cards keep a fixed order (applications · saved · views) because the recruiter’s question is “are we already talking to this person?” before “who looked”.',
              'The three tabs read History · Team notes · My notes; the two notes tabs are still the proposal above and carry no data yet.',
            ],
          },
          {
            heading: 'CV Search product panel — the top card of the rail, in four states',
            text: 'The recruiter’s first question on a CV-search screen is commercial: can I open this person, what does it cost me, how much do I have left. So the rail leads with the product they hold, in whichever state it is in, and the candidate cards follow. One component, four states, driven entirely by the entitlement record (Products & Packages → “Entitlement is the single downstream record”; Product usage → CV pack activation). Figma: https://www.figma.com/design/ljutPxIbZWjbmpaZfSyeBN/Saramin?node-id=2421-10728 (the four cards) · the three page states side by side: Case 3 active https://www.figma.com/design/ljutPxIbZWjbmpaZfSyeBN/Saramin?node-id=2378-60540 · Case 2 not activated https://www.figma.com/design/ljutPxIbZWjbmpaZfSyeBN/Saramin?node-id=2435-10823 · Case 1 no package https://www.figma.com/design/ljutPxIbZWjbmpaZfSyeBN/Saramin?node-id=2435-11967.',
            table: {
            ...
            items: [
              'LOW QUOTA: at ≤ 20% unlocks left (the Home-dashboard threshold) the number and bar turn amber and a “Buy more” link joins the actions; at 0 the state is Ended even if days remain.',
              'TWO PACKS: when a second pack is provisioned while one is active, the active pack’s card shows and the waiting one is a single line under it (“CV Search 30d waiting · activate by dd/mm”). Whether both may run at once is the open question on Product usage.',
              'THE PACE LINE IS DERIVED, NEVER STORED: unlocks used ÷ total against days elapsed ÷ window; “on track” below 1.2×, “ahead of pace” above — a planning cue, not a warning.',
              'PRICES: list prices are shown in state 1 because a recruiter deciding whether to ask must know the order of magnitude; the quotation carries the real price (discount modes live in CRM).',
              'The card never shows a candidate fact and the candidate cards never show money — the split keeps the rail readable and lets every company user read the candidate cards while prices stay with the product card.',
            ],
          },
          {
            early: true,
            ...
            items: [
              'A DOUBT CV IS NOT IN THE POOL — “Not enough information” and “Can’t read” both keep a CV out of the index until the current version is Qualified — an admin approves it, or the candidate replaces it with a version the scan qualifies. Nothing releases it automatically; BOTH doors now fail closed and wait for a human.',
          ...
          },
          {
            ...
            items: [
              ...
              'FOURTH OPTION, AND THE SHARPEST — a candidate-side COMPANY BLOCKLIST: the jobseeker names the companies that must never see their CV in search, instead of hiding a field from everyone. It closes the case that actually matters — the current employer finding them — at full strength, while every other recruiter still reads a complete profile. Saramin KR has this. Recommended over broader masking, which pays for one employer’s curiosity with every other employer’s ability to judge. Needs a client decision; not in Phase-1 scope.',
            ],
          ...
          {
            early: true,
            heading: 'Saramin KR — the four rules printed under the offer feature',
            text: 'KR shows the candidate a four-line notice wherever a recruiter can approach them. Read as product rules rather than copy, it answers the blocklist question above and adds three more that we have not specified anywhere. Evidence, not a decision — borrowing any of it still needs a written reason.',
            table: {
              cols: ['What KR tells the candidate', 'The rule underneath it', 'Where it lands for us'],
              rows: [
                [
                  '“You can set your current workplace and specific companies as restricted access targets.”',
                  'A candidate-side **company blocklist** — and it is TWO controls, not one: the current employer (resolved from the CV, so it follows a job change) plus a hand-picked list of named companies.',
                  'Settles the fourth option above: KR does have it, and the current-employer case is handled separately from the named list. Still a client decision, still out of Phase-1.',
                ],
                [
                  '“To prevent identity theft, you can receive offers after your mobile phone and email have been verified.”',
                  'Verification **gates the offer channel**, not just the account. An unverified candidate is still searchable and can still apply — they simply cannot be approached.',
                  'New. Our verification rules cover sign-up; nothing says a channel can be gated on them. Decide whether an unverified CV is hidden from search or merely unreachable — KR chose unreachable.',
                ],
                [
                  '“We are sending you a position offer via the contact information registered in your resume.”',
                  'The offer is delivered to the contact details **on the CV**, not the ones on the account profile. The two can differ, and the CV wins.',
                  'New, and it has a snapshot edge: if a CV is versioned, an offer sent against v.1 used v.1’s contact details. Name which one a delivery reads.',
                ],
                [
                  '“Please be aware of crimes targeting job seekers, such as inducing them to perform duties different from the job offer, or directing them to an interview location other than the designated workplace.”',
                  'A **fraud-awareness notice renders with the offer** — naming the two specific scams (bait-and-switch duties, an off-site interview address) rather than a generic caution.',
                  'New. Cheap to copy and worth copying: both scams are common in the VN market, and the specificity is what makes a warning read rather than skip.',
                ],
              ],
            },
            items: [
              'THE NOTICE IS THE FEATURE SPEC IN MINIATURE. Each line exists because a candidate would not otherwise hand over a phone number: I can hide from my boss, nobody reaches me until I am verified, you already know where to send it, and here is what a scam looks like. Ship the offer channel without those four and the reply rate is the thing that suffers.',
              'The privacy promise that sits above this notice on KR — “your contact details are protected until you accept” — is the same bargain as our unlock model, seen from the candidate’s side rather than the recruiter’s. Worth saying out loud on the jobseeker surface; we currently only state it to the buyer.',
            ],
            warn: 'None of this is in Phase-1 scope. It is recorded here so the blocklist decision is made once, with what the reference product actually does in front of the client, instead of being re-argued from memory.',
          },
          {
            early: true,
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ...
                ['Jobseeker job search', 'Jobseeker site — search facets. NO written requirement: the JS Job list / Job detail specs were removed on 2026-09-08, so this row is the only place the facet is described.', 'The mirror-image salary facet — range + currency, scoped not converted, with its own excluded-count line.'],
    ...
    },
    {
      ...
      detail: {
        ...
        sections: [
          {
            ...
            items: [
              ...
              'RECALL ONLY EXISTS WHERE A CV WAS ALREADY DELIVERED. Rejecting a CV that is still in doubt recalls nothing — it was never **Sent**, so it stays **Not sent** and no employer is ever notified. Read **Recall** as what rejection does to something already out the door, never as what rejection does.',
          ...
          {
            early: true,
            heading: 'ONE CV MODEL — a CV is a VERSIONED record, whichever way it was made',
            text: 'DECIDED 2026-08-23. There is one kind of thing on the shelf: a CV. It has a stable identity and a history of VERSIONS, and the only difference between the two routes is how a new version gets made — you replace the file, or you save the form. Everything downstream reads the version, never the route.\n\nThis supersedes a same-day draft that made uploaded CVs IMMUTABLE (replace = delete + create a new row). That was avoiding the versioning problem rather than solving it, and it cost the thing candidates actually rely on: a CV keeps its identity, its name and its history when they swap the file. Since Saramin CVs need versions regardless, having versions everywhere is strictly simpler than having two update models.',
            table: {
              cols: ['', 'Uploaded CV', 'Saramin CV'],
              rows: [
                ['What the candidate manages', 'One CV on the shelf', 'One CV on the shelf — same thing'],
                ['How a NEW VERSION is made', 'Replace the file', 'Edit the fields and save'],
                ['Identity across an update', '**Kept** — same CV, same name, same application history', '**Kept**'],
                ['What carries the STATUS', '**The CV** — set by the verdict on its current version. History records which version each verdict judged.', '**The CV** — same'],
                ['What an application references', 'The exact version sent', 'The exact version sent'],
                ['What CV review judges', 'A version', 'A version'],
                ['Can it degrade from Qualified to doubt?', 'Yes — a worse file swapped in', 'Yes — fields removed'],
              ],
            },
            items: [
              '★ THE ADMIN ACTS ON THE CV; THE SYSTEM COMPARES VERSIONS. Two framings, kept deliberately apart (client, 2026-08-23). What a reviewer does is reject **the CV** — the whole record on the shelf — and its status becomes Rejected on every surface. What the system then does is look at each application and ask one question: does the version this employer is holding equal the version just judged? The version is never something an admin picks or thinks about; it is what makes “which document did the employer receive?” and “what changed since?” answerable, so the recall can be per application while the verdict stays on the CV.',
              'REPLACING THE FILE IS AN UPDATE, NOT A NEW CV — the candidate keeps the CV they have been using, with the applications already sent from it still pointing at the version that was sent. Making them delete and re-upload would have thrown away that continuity to save us a version table we were building anyway.',
              'A NEW VERSION IS RE-SCANNED, ALWAYS, on both routes. Saving fields or swapping a file re-runs the qualification rule, which is what allows a CV to move between Qualified and doubt in either direction without anyone intervening.',
              'A NEW VERSION DOES NOT LAUNDER A REJECTION — this is the rule that keeps the loop honest. Uploading a fresh file onto a Rejected CV returns it to DOUBT (pending review), never straight to Qualified, and the previous rejection stays visible in its history. Otherwise “reject → re-upload the same file → qualified” is a two-click bypass of the whole review.',
              'THE OLD VERSION IS RETAINED, NOT DESTROYED. `CvVersion` already exists for exactly this — “a replace adds a version rather than destroying the old file, since applications reference snapshots”. What a superseded version does lose is its place on the shelf: it stops being one of the candidate’s up-to-3 choices, while staying retrievable for whatever references it. Retention is not the same as occupying a slot.',
              'STILL NOT ADOPTED FROM KR: the RESUME WRAPPER as a container of OTHER documents — 경력기술서 (career statement) and 추가서류/첨부파일 (extra attachments) bundled beside the CV. Unifying the update model does not bring that back. If those are wanted they attach to the CV as fields, so CV review still opens one document and judges one document. Worth a client decision if the extra sections turn out to be needed.',
            ],
            warn: 'THE ONE THING THIS MODEL MUST NOT LOSE: a CV must never present a version’s status as if it belonged to the CV as a whole when the two disagree. The shelf row shows the CURRENT version’s status; an application row shows the status of the version IT holds. They are frequently different — a candidate degrades their CV, the shelf reads doubt, and an application sent last month is still perfectly Sent on a Qualified version. Any screen that reads cv.status without asking “which version?” will eventually show one of those two the other’s answer.',
          },
          {
            early: true,
            heading: 'VOCABULARY — two nouns carry the whole version model: CV and version',
            text: 'DECIDED 2026-09-03. Every conversation about this feature needs exactly two nouns, and they are the two entities already in the data model. The **CV** is the container — the item on the shelf, with an identity, a name, a history and one of the candidate’s three slots. A **version** is the content at a point in time — what a reviewer judges, what an application or an unlock captures, what an employer actually holds. The two routes differ only in what a version is made of: a **file** on the upload route, a saved **form** on the Saramin route.\n\nThere is no third thing. The “wrapper” KR has around a resume does not exist here: the CV *is* the container, and what is inside it is versions.',
            table: {
              cols: ['Term', 'What it is', 'Upload CV', 'Saramin CV', 'Say it like'],
              rows: [
                ['**CV**', 'The container on the shelf — identity, name, history, the CV-search pick, one of the 3 slots. Its status is the status of its current version.', 'One CV', 'One CV — the same thing', '“the candidate has 3 CVs” · “this CV is on v.3” · “the admin rejects the CV”'],
                ['**version** — `v.N`', 'The content at a point in time. Immutable once made. What review judges and what an application or unlock captures.', 'one **file** (PDF/DOC)', 'one saved **form** (structured fields, rendered to PDF)', '“the employer holds v.1 of this CV” · “a reject judges a version”'],
                ['**current version**', 'The newest version — the one on the shelf, the one CV review and CV search ever see. The denominator in every `v.1/2` label.', 'the file uploaded last', 'the form as last saved', '“the CV is on v.3” · “v.1/2 — behind the current one”'],
                ['**snapshot**', 'Not a third noun — the *relationship* between an event and a version. An application, an unlock or a delivery snapshots the version current at that moment and keeps pointing at it.', 'same', 'same', '“the application snapshots v.1” · “the row shows the snapshot, not the CV”'],
                ['**new version**', 'What an update produces, on either route. Re-scanned, always; never launders a rejection.', 'replace the file', 'edit the form and save', '“replacing the file makes v.2 of the same CV”'],
              ],
            },
            items: [
              'IN THE DATA MODEL THE NOUNS ARE `Cv` AND `CvVersion` — nothing to rename. `CvVersion` carries `documentUrl` for both routes; on the Saramin route it also carries the saved fields, since the PDF is a rendering of them and the fields are what the next edit starts from.',
              'WORDS DELIBERATELY NOT USED. **Resume** for the container — it is KR’s wrapper-of-documents, the model this page dropped, and using the word brings it back in every meeting. **Hồ sơ / Profile** — already means My Profile. **bản / phiên bản** — the label is `v.N`, decided. **Document** as the noun for content — fits a file, not an editable form, and “version” already does the job.',
              'WHERE THE REST OF THE VERSION LOGIC LIVES on this page, so it is not repeated here: the model itself is the section above; [the recall rule — a reject touches only applications carrying the rejected version](#cv-status-one-field-four-values-two-of-them-interim); [every surface that shows a version, and the acceptance test](#where-the-version-is-actually-visible-every-surface-that-shows-one-and-none-of-them-optional); [the worked example — Qualified, sent, thinned, rejected, earlier application untouched](#worked-example-qualified-sent-then-thinned-by-the-candidate-and-rejected-the-earlier-application-is-not-recalled); [the status matrix](#the-matrix-one-cv-status-every-surface-that-shows-it).',
            ],
          },
          {
            early: true,
            heading: 'WHAT A ROW IS — CV review lists versions, Talent pool lists CVs, an application follows a version',
            text: 'DECIDED 2026-09-03 (client question). Three lists, three different units — and the fraction tells you which one you are looking at. Getting the unit wrong produces one of two failures: phantom work (a reviewer judging a version nobody will ever see) or a lost application (one that waits on a version the candidate has already replaced).',
            table: {
              cols: ['Surface', 'One row is', 'Which version', 'Can a row read v.1/2?'],
              rows: [
                ['**CV review**', 'A **version** a human had to look at — one row per version in doubt or reported, plus the record of each decision made', 'Cần duyệt: only the **current** version can be waiting. Đã duyệt / Đã từ chối: the version the decision was made on', 'Cần duyệt: never — always N/N. Record views: yes — `v.1/2` means the candidate has moved on since that decision'],
                ['**Talent pool**', 'A **CV** — one row per candidate CV switched on for search', 'Always the **current** version; the index never serves any other', 'Never — always N/N'],
                ['**Applicants**', 'An **application**', 'Delivered: the version **delivered**, frozen. Held (Not sent): none yet — it delivers whatever is current when it is released', 'Delivered rows: yes. Held rows: no — they float with the CV'],
              ],
            },
            items: [
              '★ A HELD APPLICATION HAS NO VERSION YET. Delivery is the snapshot event, so an application that is Not sent floats with its CV and goes out with whatever version is current the moment the CV becomes Qualified. That moment comes two ways — an admin approves the current version, or the candidate replaces it with a version the scan qualifies — and both release the held applications on the new version. It is the same outcome as if the candidate had applied with the new version, which is what they meant.',
              'AN OLDER VERSION IN DOUBT IS SUPERSEDED, NOT REVIEWED. Once the candidate moves the CV to v.2, a v.1 that was waiting in Cần duyệt has nothing depending on it: no held application (they float), no search (it serves the current version), no delivery (nobody will ever receive v.1). It leaves the queue by itself, with no human decision, and its record reads superseded — `v.1/2`. Only the current version can be awaiting review, so Cần duyệt holds at most one row per CV.',
              'A REJECTED OLDER VERSION STAYS IN THE RECORD — a human decision is never auto-closed. Its row reads `v.1/2` once the candidate uploads v.2, and v.2 itself enters Cần duyệt as `v.2/2` even when the scan passes it, because a new version does not launder a rejection. The queue row says so, so the reviewer knows why a passing scan is in front of them.',
              'THE CLIENT’S SCENARIO, WORKED. v.1 is in doubt, one application is held. The candidate updates → v.2, and the scan qualifies it. Then: the held application is **delivered with v.2**; the v.1 row is **superseded and leaves Cần duyệt** (record: `v.1/2`); v.2 **never appears on CV review** — the scan qualified it; Talent pool shows **one row, `v.2/2`**. So this CV has zero waiting lines, not two. The neighbouring cases do show two: (a) v.2 is also doubted → Cần duyệt shows `v.2/2`, the held application keeps waiting, v.1 is superseded in the record; (b) v.1 had been rejected → the held application was already Not sent (final), v.2 enters Cần duyệt as `v.2/2`, and Đã từ chối keeps `v.1/2` — two lines, in two views.',
              'WHY NOT BIND A HELD APPLICATION TO THE VERSION AT APPLY TIME. It would force the admin to review a superseded version for the sake of one application, and approving it would deliver a document the candidate has already replaced — the employer gets the worse file and the candidate never learns why. Binding at delivery costs nothing and produces the outcome every party wanted.',
            ],
          },
          {
            early: true,
            ...
            table: {
              ...
              rows: [
                ['What the scan checks', '`OR [ Work experience, Education ]`', 'The same rule, on the fields extracted from the file'],
                ...
                ['A CV in DOUBT…', 'cannot be attached to an application at all, and cannot be toggled on', 'CAN still be applied with, but the CV is **Not sent** until the current version is Qualified — an admin approves it, or the candidate replaces it with a version the scan qualifies — nothing releases it on a timer. CAN be toggled on, but stays **Hidden**'],
          ...
          },
          {
            ...
            table: {
              cols: ['Must have', 'Why'],
              rows: [
                ['≥ 1 work experience **OR** ≥ 1 education entry', 'It is the body of the document. Zero entries in both means a name and white space, and that is the only thing this gate is built to catch.\n\n**PROJECTS LEFT THE RULE 2026-09-25 (Thu).** The second branch used to read *education AND ≥1 project*, on the argument that a school name and a date alone say nothing about what someone can do. That argument is not wrong, but it charged the least experienced candidates the most work to get through the gate — and the cost of being wrong is asymmetric: a thin CV that qualifies is merely thin and ranks nowhere, while a real CV held out of the index is invisible. One entry of either kind is now enough.\n\nMAKING EDUCATION MANDATORY FOR EVERYONE was considered on 2026-09-11 and REJECTED, and that still stands: it would gate on the weakest signal we hold — education level buys 3 of the 100 match points against 30% for work experience — and would reject the driver, foreman or salesperson with twenty years behind them who never filled the field in. Work experience alone still passes.'],
            ...
            items: [
              ...
              '★ THE BUILD IS ONE CHANGE BEHIND THIS PAGE (checked 2026-09-25). svn-be implements the rule in one place — `svn-domain/…/recruitment/cv/CvQualificationRule.java` → `exp >= 1 || (edu >= 1 && proj >= 1)`, with `!hasTextLayer` → Can’t read, else Not enough information. **Dropping projects is a one-line change there**: `MIN_PROJECTS` goes, the disjunction becomes `exp >= 1 || edu >= 1`, and the test row `"0, 1, 0, 3, true, NOT_ENOUGH_INFORMATION"` in `CvQualificationRuleTest.java` flips to QUALIFIED. Everything else on this page already matches: skills are counted but not read by the verdict (≥3-skills gate deleted in commit 92c0162), counts are row counts on resume_experience / resume_education / resume_project, and there is **no education-mandatory rule and no Fresher/Experienced toggle** anywhere in the three repos. FE never re-implements the rule; it mirrors the BE status string, so no FE change is needed.',
              '⚠ TWO BUILD FACTS THE SPEC CANNOT SEE, both worth a dev conversation. ① THE RULE SHIPS BEHIND A FLAG THAT IS OFF — `SVN_CV_QUALIFICATION_ENABLED:false` (application.yml) no-ops the WRITE paths, but the READ path is not flag-guarded, so the Saramin-CV apply gate still returns 409 `CV_NOT_QUALIFIED` regardless of the flag. On/off is therefore not a clean switch. ② CV SEARCH READS THE STORED VERDICT, NOT THE RULE — `ResumeIndexSourceAdapter` filters on `approval_status = APPROVED`, and a candidate with NO flagged CV indexes as qualified rather than being excluded.',
              '⚠ STALE “≥3 skills” COPY STILL IN THE BUILD (this page is already correct). `CvRejectMessages.java` — live product copy, not a doc — still tells candidates “bổ sung kinh nghiệm làm việc và ít nhất 3 kỹ năng”, which contradicts the rule the same repo implements. The correct wording already exists in `CvQualifyReason.java` (“needs work experience, or education plus a project”). Four docs under svn-be/docs and the application.yml comment repeat the dead ≥3-skills formulation.',
          ...
          },
          {
            ...
            items: [
              ...
              '★ BUT A REJECTION ONLY RECALLS THE APPLICATIONS THAT ACTUALLY CARRY THE REJECTED VERSION (corrected 2026-08-23 — the earlier rule recalled everything and was wrong). The case that breaks it: a CV is Qualified, an application is Sent, and THEN the candidate strips half the fields out. The scan drops it to Not enough information, an admin rejects it — and under a blanket rule the employer loses a CV that was perfectly good when they received it, because of an edit made afterwards. The employer is punished for something they could not see and did not do.',
              'THE TEST IS ONE COMPARISON: does this application’s CV SNAPSHOT match the version being rejected? SAME version → the verdict is about the document the employer is holding → **Recall**. DIFFERENT version → the sent document is not the one being judged → **leave the application exactly as it is**. This is per-application, so one reject can recall some rows on a CV and leave others alone, and that is correct rather than an inconsistency.',
              'WHY THIS IS SAFE — the cases that SHOULD recall still do, because in all of them the sent version IS the rejected one: a CV the scan wrongly qualified, a fake or duplicate discovered later, a CV an employer reported. Nothing that deserves recall escapes; only the “they degraded it after sending” case stops being punished.',
              'IT NEEDS VERSIONS, AND THEY ALREADY EXIST — `CvVersion` is in the data model precisely because “a replace adds a version rather than destroying the old file, since applications reference snapshots”. This rule is what that entity was for; without a version on each application there is no way to ask the question at all.',
              'IT APPLIES TO BOTH ROUTES, NOT JUST SARAMIN CVs. An uploaded CV degrades the same way — swap a clear file for a blurry one and the scan drops it to Can’t read exactly as removing fields would. The comparison does not care which route made the version; it asks only whether the sent version is the rejected one. (An earlier draft made uploads IMMUTABLE so they could never reach this case — that is no longer the model; see the CV-model rule above.)',
              ...
              'NOTHING IS RELEASED ON A TIMER (decided — the 24h auto-send is removed). A Not-sent application on a DOUBT CV stays Not sent until the CV’s current version is Qualified — an admin approves it, or the candidate replaces it with a version the scan qualifies — and is then delivered on the version current at that moment. The row therefore carries an AGE rather than a countdown — “waiting 5h”, the same sub-line the CV-search cell uses — and that age is now the only thing that complains about an unworked queue.',
          ...
          },
          {
            ...
            text: 'A version that only exists in the database is a rule nobody can check. If an operator cannot SEE which version they are rejecting, they cannot tell a correct recall from a wrong one, and the whole correction above is unverifiable in production. So the version has a place on every screen where the question “which document?” can be asked — and the reject dialog in particular must state its consequences as a SPLIT rather than a promise.',
            table: {
              cols: ['Surface', 'What it shows', 'Why there'],
              rows: [
                ['**Admin · CV review** — row', '`v.N/N` beside the Upload pill — always', 'One notation on every admin list (client, 2026-09-03): the fraction, judged over current. In Cần duyệt it always reads N/N — only the current version can be waiting. In Đã duyệt / Đã từ chối it can read `v.1/2`, which is how a reviewer sees the candidate has moved on since that decision. Printed on every row so CV review, Talent pool and Applicants agree, and so nobody has to ask “version mấy?”.'],
                ['**Admin · Talent pool** — row', '`v.N/N` beside the kind pill — always', 'Same notation, same reason; the pool only ever shows the current version.'],
                ['**Admin · CV review** — Dùng để ứng tuyển', '`2 đơn dùng v.3` — applications carrying the **current** version only; deliveries on earlier versions live in the tooltip', 'The reviewer decides on v.3. Applications delivered on v.1 are untouched by that decision and, in the client’s words, “không quan tâm” — counting the whole CV would overstate what the verdict touches. This column is also where the consequence count now lives (see the dialog row).'],
                ['**Admin · CV review** — CV search', '`Đã chọn · v.3`', 'Search only ever serves the current version, so the candidate’s pick is stated against it.'],
                ['**Admin · reject dialog** — title only', 'The version judged, in the same notation: `scan_0816.pdf · v.1/1`. **No consequence block** (removed 2026-09-03 on client feedback) — the footer sentence points at the *Dùng để ứng tuyển* column instead: “chỉ chạm vào đơn dùng v.3 (cột Dùng để ứng tuyển). Đơn dùng version cũ không đổi.”', 'The dialog used to count held / recalled / untouched applications. That duplicated the row, and the client asked for it to go: the count lives in ONE place, the column, and the dialog stays a form.'],
                ['**Admin · Applicants** — CV cell', 'The file **as delivered** (name and content of the sent version), and the version as a fraction — delivered **over** current, always: `v.2/2` when the employer holds the current one, `v.1/2` (bordered) when the shelf has moved on. The client’s notation.', 'The row is the application, so its document is the snapshot. Also explains the only row shape that otherwise looks like a bug: CV status **Rejected** sitting beside application status **Sent**.'],
                ['**Jobseeker · My CVs** — meta line', '`v.3 (đã thay 2 lần)`', 'Teaches the model at the point of confusion: replacing a file UPDATES this CV, so nobody burns one of their three slots to fix a typo — and applications already sent keep the version they were sent.'],
              ],
            },
            items: [
              '★ THE APPLY COLUMN IS THE ACCEPTANCE TEST for the version rule (the dialog’s consequence block was removed on 2026-09-03). On a CV with 2 applications delivered on v.1 and 2 on v.3, *Dùng để ứng tuyển* must read `2 đơn dùng v.3`, not 4 — and after the reject, Applicants must still show the two v.1 rows as **Sent**. If the column reads 4, or those rows read Recall, the blanket behaviour is back in the code no matter what the spec says.',
              'THE COLUMN’S COUNT AND THE RECALL SET COME FROM ONE QUERY — group this CV’s applications by (delivered?, cvVersion == current?). Column = not delivered + delivered on the current version. Recall on reject = delivered on the current version. Untouched = delivered on an earlier one; they surface only in the column’s tooltip.',
              '★ THE CV CELL ON AN APPLICATION ROW IS THE SNAPSHOT, NOT THE RECORD (client, 2026-08-23). On Applicants — the admin’s list and the employer’s alike — the CV name opens the version delivered with THIS application, carrying the file name it had on the apply date, even when the candidate has since replaced the file under a new name. It never resolves to the CV’s current version: that is the candidate’s shelf, and this employer was never sent it. The version badge beside the name is what says the two have diverged; the tooltip names both files.',
              'ONE NOTATION, EVERYWHERE ON THE ADMIN CONSOLE (client, 2026-09-03): the fraction — the version this row is about, over the CV’s current version. `v.3/3` in Cần duyệt, on Talent pool and on the reject dialog title, where the two are by construction the same; `v.1/2` on a CV review record row or an Applicants row that is behind, `v.2/2` on one that is not. Equal numbers = current. Never a bare number, never a word. DECIDED 2026-09-03 against two alternatives: an arrow (`v.1 → v.2`, quieter, but “current” would be signalled only by the badge’s absence) and a word (`v.1 · cũ` / `v.1 · mới nhất`, explicit, but the current version number drops to a tooltip). The fraction puts both numbers on every row and never relies on absence — the header sentence defining `v.1/2` on Applicants is the price, and it is one line.',
              'ADMIN SURFACES ALWAYS SHOW THE VERSION, v.1 INCLUDED (client, 2026-08-23). An earlier draft hid v.1 as noise; the reviewer’s “làm sao tôi biết đây là version mấy?” is the answer to that — on a console where the verdict is per version, the version is never noise. The hide-v.1 rule survives only on the candidate’s My CVs, where the number is a hint about update semantics rather than something anyone acts on.',
              'THE EMPLOYER IS NOT TOLD THE CANDIDATE’S CV GOT WORSE, and the `v.1/2` label is internal to the admin console for that reason. What an employer may eventually be offered is that a NEWER version exists — an invitation, priced or not — never a verdict on a document they are holding and are entitled to keep.',
              'OPEN — NO VERSION HISTORY UI FOR THE CANDIDATE IN PHASE 1. The count is shown; the list of past versions is not. Retrieving an old version is an admin/support action against `CvVersion`. Worth revisiting only if support volume says candidates actually ask for it.',
            ],
          },
          {
            heading: 'WORKED EXAMPLE — Qualified, sent, then thinned by the candidate and rejected: the earlier application is not recalled',
            text: 'The rule in one sentence is easy to nod at and hard to trust. This is the case the client asked to see end to end — one uploaded CV, two applications, one rejection — with the state of every entity at every step and the exact UI each party gets. Click a step; the timeline on the left is readable without clicking. Read the CV column down and it changes four times; read Đơn #1 down and it never changes. That contrast is the whole rule.\n\nThe framing to hold onto: **the admin rejects the CV** — the whole record — and it reads Rejected everywhere. **The system compares versions**, per application, to decide which deliveries to pull back. The version badge on the admin’s Applicants row is what lets “CV Rejected” and “application Sent” sit side by side without looking like a bug.',
            diagram: 'cv-version-story',
            table: {
              cols: ['#', 'Ngày', 'Sự kiện', 'CV', 'Đơn #1 (FPT)', 'Đơn #2 (Tiki)', 'Rule that fired'],
              rows: [
                ['1', '01/07', 'Upload CV_TranMinhAnh.pdf — 3 exp · 8 skills', '**v.1 · Qualified**', '—', '—', 'Passes the qualification rule. No human. Never enters the queue.'],
                ['2', '05/07', 'Applies to FPT', 'v.1 · Qualified', '**Sent · v.1**', '—', 'Qualified → Sent immediately. **The application snapshots v.1.**'],
                ['3', '12/07', 'FPT → Interview', 'v.1 · Qualified', 'Sent · v.1 · Interview', '—', 'Stage is the employer’s. Shows the employer has invested in this exact document.'],
                ['4', '20/07', 'Replaces the file with a 1-page version — no work history, no education', '**v.2 · Not enough information**', 'Sent · v.1 · Interview **(unchanged)**', '—', 'New version → re-scanned → neither branch met → doubt → **enters CV review**. (Corrected 2026-09-25: this row used to read “1 exp · 2 skills”, which stopped failing the moment the ≥3-skills gate was dropped — one work entry has qualified on its own since 2026-09-11.) Đơn #1 is a snapshot → untouched. Doubt never recalls. Candidate sees no chip (upload doubt is invisible); FPT is not told.'],
                ['5', '21/07', 'Applies to Tiki with the same CV', 'v.2 · Not enough information', 'Sent · v.1 · Interview', '**Not sent · held**', 'Doubt → held, waits for an admin. Candidate sees “Đã nộp”, one step short of “Đã gửi”.'],
                ['★ 6', '22/07', 'Hà rejects — “CV but not enough information”', '**v.2 · Rejected**', '**Sent · v.1 · Giữ nguyên ✓**', '**Not sent · Không được gửi (final)**', '**Reject applies to the CV.** Then per application: version == v.2? Đơn #1: v.1 ≠ v.2 → keep. Đơn #2: never delivered → not sent. **Thu hồi: 0** — nothing was ever delivered on v.2.'],
                ['7', '22/07', 'After — what each side sees', 'Rejected', 'Sent · Interview', 'Not sent', 'Candidate: rejection chip on the **CV**; FPT row still **Interview**; Tiki row **Không được gửi** + admin’s message. FPT: nothing changed, not told. Admin Applicants: `Rejected · Sent · Interview` + `v.1/2`.'],
              ],
            },
            items: [
              'WHEN “THU HỒI” ACTUALLY HAPPENS — not in this story, and that is the point. Recall needs a version that was **delivered** and only then rejected: e.g. v.2 passes the scan, goes to Tiki as Sent, Tiki reports it as not a real CV, Hà rejects v.2 → Đơn #2 (v.2) **Recall**, Đơn #1 (v.1) still **kept**. The candidate thinning their own CV can never produce a recall, because a thinned version fails the scan before it can be delivered.',
              'THE SARAMIN-CV VERSION OF THIS STORY IS SHORTER. Removing fields drops it to Not enough information too — but the candidate sees that at once (amber chip, Cập nhật button), the CV cannot apply until fixed, and it **never reaches an admin**: the check is arithmetic on fields they typed, so there is nothing for a reviewer to judge. There is no step 6. Đơn #1 is untouched because doubt never recalls — and because nobody ever rejected anything.',
              'FOR THE TESTER, THE ASSERTIONS ARE THE Đơn #1 COLUMN: after step 4 it is Sent; after step 6 it is Sent; FPT’s opened document is byte-identical to what was delivered on 05/07 at every step. If any of those flips, the blanket recall is back.',
              'FOR THE DEVELOPER, STEP 6 IS TWO WRITES AND ONE QUERY: set the CV’s status to Rejected (recording the version judged); then group this CV’s applications by (delivered?, cvVersion == judged version) → held → Not sent; delivered & equal → Recall; delivered & different → no write at all. The third group is the one that must produce **no write** — not a write of the same value.',
            ],
          },
          {
            early: true,
            heading: 'FOUR REJECT REASONS — what each means, and who is allowed to pick it',
            text: 'One “rejected” cannot carry three different problems. A CV that is finishable, a file we cannot read, and a document that is not a CV at all need different words and different fixes. The reviewer picks one, and the code they pick then selects everything the candidate is shown — so this is the only decision on the page with more than one answer.\n\nA FOURTH CODE, “Khác”, exists so the list can stay SHORT. Without a pressure valve a reviewer facing a real case that fits none of the three has to force it into the nearest wrong box, and the wrong box then drafts the wrong message. Khác is also the metric that tells us when a fifth code is owed.',
            table: {
              ...
              rows: [
                ...
                [
                  '{{code:Khác}}\nthe pressure valve',
                  'A real case that fits none of the three. The reviewer writes the whole message themselves: NOTHING is drafted for this code, and the message is required, so picking Khác is strictly more work than picking a real code — which is what stops it becoming the lazy default.',
                  '**ADMIN ONLY** — the scan can never reach for it',
                  'THE MOST IMPORTANT NUMBER ON THIS TABLE. A rising share of Khác is the signal that a fifth code is owed: reviewers are repeatedly hand-writing the same message, and that message should become a draft.',
                ],
              ],
            },
            items: [
              'ONLY “NOT A CV” AND “KHÁC” NEED A HUMAN JUDGEMENT — the other two are the scan’s own output, which is what keeps the review queue small enough to work. It is also why the admin action is Reject WITH A REASON rather than a bare Reject: the code is what selects the candidate’s message.',
              'WHICH REASONS EXIST DEPENDS ON THE ROUTE, and this is the part most often got wrong. An UPLOADED CV can hit all three specific codes: there is a file, so it can be unreadable, and it can turn out not to be a CV at all. A SARAMIN CV can only ever hit **CV but not enough information** — it is fields the candidate typed into our own form, so there is no file to fail on and it cannot be “not a CV”. (Khác is available on both routes, by definition.) Offering “Tải lên CV khác” to someone who never uploaded anything is the bug this rule prevents.',
              ...
              'THE FIX DIFFERS BY REASON, and that is the whole reason for four names rather than one. Telling someone whose upload was a price list to “add work experience” is advice they cannot act on; telling someone with a thin but real CV to re-upload throws away work they have already done.',
              'NOT IN THIS LIST, ON PURPOSE: fake, misleading, abusive, duplicate. Those are judgements about the ACCOUNT, not the document, and they have their own lever — **Block user** — which stops that person signing in and does nothing else (revised 2026-08-23). Filing them as a CV reason would bury an account that needs blocking inside a row that looks like a bad upload. NOTE THE CONSEQUENCE, because it is the one operators get wrong: blocking does NOT pull their CVs or applications back. If a fake profile is already in employer hands, BOTH actions are needed — block the account, and reject the CV — and the block dialog says so with a link.',
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                [
                  '**Qualified**',
                  'Không có chip trạng thái nào.\n{{tagok:Hiển thị trong tìm kiếm CV}} trên đúng CV được chọn cho CV search.\nCV detail: không có thông báo gì.',
                  '{{tagmute:Đã gửi}} rồi tới các bước của NTD (Viewed · Interview · Offer…)',
                  'Một dòng bình thường, chạy theo pipeline của NTD.',
                  'Có trong pool — nhưng CHỈ khi đúng là CV được bật và tài khoản đang Discoverable. Ngược lại là VẮNG MẶT, khác hẳn với bị ẩn: nó chưa từng được chọn.',
                ],
                [
                  '**Can’t read**\nDOUBT · chỉ có ở CV upload · đang nằm trong hàng đợi duyệt',
                  'KHÔNG hiển thị gì — y hệt một CV bình thường.',
                  'KHÔNG hiển thị gì đặc biệt — vẫn là {{tagmute:Đã nộp}} như mọi đơn đang chờ.',
                  'KHÔNG có gì — chưa từng gửi đi.',
                  'KHÔNG có trong pool — **Hidden** cho tới khi admin duyệt.',
                ],
                [
                  '**Not enough information**\nDOUBT',
                  'Upload: KHÔNG hiển thị gì.\nSaramin CV (không vào hàng đợi):\n{{tagwarn:⚠ Chưa đủ thông tin}}\n{{btn:Cập nhật hồ sơ}}',
                  'Upload: KHÔNG hiển thị gì đặc biệt.\nSaramin: KHÔNG có đơn nào — không chọn được để ứng tuyển.',
                  'KHÔNG có gì — chưa từng gửi đi.',
                  'KHÔNG có trong pool — **Hidden**.',
                ],
                /* THE FOUR REJECTIONS. Same tag, different words — which is the only
                   reason four codes exist. The candidate cell is drawn as the ACTUAL
                   three elements (tag · message · button) rather than described,
                   because a developer reading “Rose Chưa được duyệt + a message +
                   Tải lên CV khác” has to rebuild the screen in their head. Employer
                   text is ONE fixed clause and carries nothing to do. */
                [
                  '**Rejected**\n{{code:Not a CV}}',
                  '{{tag:Chưa được duyệt}}\n{{note:File bạn tải lên không phải một CV. Bạn kiểm tra và tải lại đúng file giúp nhé.}}\n{{btn:Tải lên CV khác}}',
                  'Chưa gửi → {{tag:Không được gửi}}\nĐã gửi → {{tag:Đã thu hồi}}\nChip thôi — lý do không lặp lại ở đây, CV chỉ cách một chạm.',
                  '{{tag:Đã thu hồi}}\n{{note:Saramin đã thu hồi CV này — file không phải một CV.}}',
                  'Rời khỏi pool. Nếu NTD đã unlock: gạch tên, **hoàn 1 lượt unlock**, dòng chữ “Không còn khả dụng”.',
                ],
                [
                  '**Rejected**\n{{code:CV but not enough information}}',
                ...
                [
                  '**Rejected**\n{{code:Can’t read}}',
                  '{{tag:Chưa được duyệt}}\n{{note:Hệ thống không đọc được nội dung trong file này. Bạn thử tải lên bản PDF xuất trực tiếp từ Word hoặc Google Docs giúp nhé.}}\n{{btn:Tải lên CV khác}}',
                  'Như trên.',
                  '{{tag:Đã thu hồi}}\n{{note:Saramin đã thu hồi CV này — hệ thống không đọc được nội dung file.}}',
                  'Như trên.',
                ],
                /* THE FOURTH REASON — “Khác”, the pressure valve. It behaves like
                   the other three on every surface EXCEPT the employer one, and
                   that exception is the reason it earns a row. */
                [
                  '**Rejected**\n{{code:Khác}}',
                  '{{tag:Chưa được duyệt}}\n{{note:(trống — không soạn sẵn. Người duyệt phải tự viết, và lời nhắn là bắt buộc nên không thể để rỗng.)}}\n{{btn:người duyệt tự chọn}}',
                  'Như trên.',
                  '{{tag:Đã thu hồi}}\n{{note:Saramin đã thu hồi CV này.}}\nCÂU TRẦN — không kèm lý do. Mã này không có clause nào đã được duyệt, và chữ người duyệt tự viết thì không bao giờ được đưa tới NTD.',
                  'Như trên.',
                ],
              ],
            },
            items: [
              ...
              '★ ONE TAG, MANY MESSAGES — the load-bearing rule. The chip is {{tag:Chưa được duyệt}} for EVERY reason; what the candidate can act on comes from a REQUIRED message the reviewer writes, drafted from the reason code and editable. A generic tag cannot be wrong and survives any future code, while the words underneath it stay specific — which is why the matrix lists the four rejections as four rows.',
              'THE MESSAGE IS REQUIRED, and that is what makes a generic tag safe. A uniform chip with no message is strictly WORSE than per-reason chips: the candidate learns that something is wrong and nothing about what. A MESSAGE WITH NO NEXT STEP IS A DEAD END, so the reviewer also picks the ACTION BUTTON — Tải lên CV khác · Cập nhật hồ sơ · Liên hệ hỗ trợ · none.',
              'THE REASON CODE IS NEVER SHOWN VERBATIM, and the employer never sees the reviewer’s written words — they get the FIXED clause for that code. The written message is composed to help one person repair a document; the same words in a recruiter’s dashboard read as a quality verdict on a candidate.',
              'EVERY EMPLOYER CLAUSE DESCRIBES THE DOCUMENT, NEVER THE PERSON — “file không phải một CV”, “hồ sơ chưa đủ thông tin”, “hệ thống không đọc được nội dung file”. That is exactly what makes them safe to show. The moment a reason would describe the PERSON (fake, abusive, duplicate) it stops being a CV rejection and becomes **Block user**, communicated as a withdrawal with no reason at all.',
              '★ NAME THE SYMPTOM, NEVER THE CAUSE — for “Can’t read”, on every surface. “File là bản scan” is a DIAGNOSIS we are not in a position to make: extraction also fails on a corrupt file, on text saved as vector outlines, on odd font embedding, and on permission-locked PDFs. State what we OBSERVED, then give an action that works whatever the cause.',
              '“CHƯA”, NOT “KHÔNG”. A rejection is reversible — Approve undoes it — and most of these are faults of the FILE, not of the person.',
          ...
          {
            early: true,
            heading: 'A DELETED ACCOUNT — what already reached the employer stays',
            text: 'ONE RULE, two halves: **what already reached an employer stays exactly as it was; the CV stops being findable.** Nothing is taken back and nothing is refunded — the employer received what they were sent, and the candidate simply left.',
            table: {
              cols: ['Where', 'What happens'],
              rows: [
                ['**Đơn ứng tuyển đã gửi**', 'Row unchanged. CV fully readable, contact details usable, employer may call or email as normal. ONE addition: a **Tài khoản không còn tồn tại** chip.'],
                ['**CV đã unlock** (CV search)', 'Identical treatment, plus: the unlock is **NOT refunded** — nothing was taken back.'],
                ['**CV search**', '**Hidden.** No new employer can find it or spend an unlock on it.'],
                ['**Đơn đang bị giữ** (CV còn nghi ngờ, chưa gửi)', 'Nothing survives — it never reached anyone. The same rule read the other way.'],
              ],
            },
            items: [
        ...
        behaviors: [
          ...
          'A “không đọc được nội dung” CV HOLDS like any other doubt — its applications stay Not sent and it stays out of CV search, both until the current version is Qualified — an admin approves it, or the candidate replaces it with a version the scan qualifies. Doubt behaves like doubt on both surfaces, and nothing underneath releases it.',
          ...
          'The searchable flag never moves TO a CV that does not qualify, and never moves off the current one until a replacement qualifies. A flagged CV that later drops below the rule keeps the flag and leaves the index; it re-enters on the save that re-qualifies it — we do NOT auto-move the flag, because a CV goes below the rule almost always because the candidate is mid-edit.',
          'The flag is a RADIO, not a checkbox — exactly one CV is flagged, flagging CV B unflags CV A, and the first qualifying CV is flagged automatically. Deleting the flagged CV moves the flag to the most recently updated qualifying survivor.',
          'The toggle is allowed on ANY CV except a Rejected one. A candidate may turn CV search on for a CV still in doubt; it simply stays **Hidden** until the CV qualifies. The toggle states INTENT, and intent is not something to refuse while a parser is still deciding — so FLAGGED-BUT-HIDDEN is a normal state, named plainly on the admin side and not named at all to the candidate.',
          'Parse on write, index on flag — every CV is parsed when it is saved, so flipping the flag later is instant and cannot fail. Account-level Hidden does not clear the flag; switching back asks nothing.',
        ...
        backend: {
          ...
          endpoints: [
            ...
            'POST /admin/cvs/:id/review { decision, note? } → qualified or rejected. In the SAME transaction it releases every held application on that CV, or drops them — and recalls the SENT ones whose cvVersion equals the version being rejected, leaving any sent on an earlier version untouched',
        ...
        sections: [
          {
            early: true,
            heading: 'WHAT A ROW IS — CV review lists versions, Talent pool lists CVs, an application follows a version',
            text: 'The same rule as on [CV qualification](/m/resume-management/cv-qualification-apply-cv-search#what-a-row-is-cv-review-lists-versions-talent-pool-lists-cvs-an-application-follows-a-version), repeated here because every number on this page is computed over Talent pool — and Talent pool counts **CVs**, not versions. A candidate who replaced their file three times is one row, one hit, one miss; a version nobody will ever see is not in the index and must not be in any denominator.',
            table: {
              cols: ['Surface', 'One row is', 'Which version'],
              rows: [
                ['**CV review**', 'a **version** a human had to look at', 'Cần duyệt: only the current one can wait. Record views: the version the decision was made on, so `v.1/2` is possible there'],
                ['**Talent pool**', 'a **CV**', 'always the current version, always N/N'],
                ['**Applicants**', 'an **application**', 'delivered → the delivered version, frozen. Held → none yet; it floats with the CV'],
              ],
            },
            items: [
              'FOR THIS PAGE THAT MEANS: index size, hit rate, index-miss and every bucket count are per **CV** — one per candidate CV switched on for search, read on its current version. A replaced file is an update to the same row, not a second row; a superseded version is not a miss, it is simply not there.',
            ],
          },
          {
