          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ...
                ['4', '20/07', 'Replaces the file with a 1-page version — 1 exp · 2 skills', '**v.2 · Not enough information**', 'Sent · v.1 · Interview **(unchanged)**', '—', 'New version → re-scanned → fails → doubt → **enters CV review**. Đơn #1 is a snapshot → untouched. Doubt never recalls. Candidate sees no chip (upload doubt is invisible); FPT is not told.'],
