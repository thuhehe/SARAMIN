      ...
      detail: {
        ...
        },
        {
          ...
          items: [
            ...
            'CREATION ASKS FOR THE LEGAL NAME AND THE MST, and little else. Everything not needed to make the record exist is asked where it is USED: tên hiển thị + company tags on the Company page tab (“Nhận diện”), industry + headcount + ngày thành lập on that tab’s “Company at a glance”, and the ĐKKD facts — loại hình, tình trạng MST, người đại diện, công ty mẹ — on the Basic info card itself, because they are looked up after the fact rather than known by the rep taking the lead. None of them blocks anything: every list falls back to the legal name, and an unset industry only leaves the facts card one row short.',
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
                        ['Thông tin cơ bản', 'Tên hiển thị, quốc gia đăng ký, tỉnh/thành, website. SECOND, not first — see the ordering rule.', 'None'],
