      ...
      detail: {
        ...
        states: [
          ...
          },
          {
            ...
            table: {
              cols: ['What', 'Approver'],
              rows: [
                ['Order % ≤ 10% (Existing)', '**Sales lead**'],
                ['Order % > 10% (Existing)', '**Sales manager** — straight there, not queued behind the lead'],
          ...
          },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['**Sales lead**', 'Quotations list → **⏳ Chờ tôi duyệt (n)**', 'Sees only ≤10% requests **from their own team**. Opens the quotation → **Duyệt** or **Từ chối**.'],
          ...
          warn: 'Open — what happens when the approver is the requester. A sales lead raising their own quotation cannot approve it, so it has to escalate to the manager; and a sales manager’s own order-level discount has nobody above them in this model.',
        },
        {
        ...
        backend: {
          dataModel: [
            ...
            { name: 'approvalRole', type: 'enum?', notes: 'sales_lead (≤10%) | sales_manager (>10%). Routed by AMOUNT, not by chain: above the band the lead is skipped entirely' },
