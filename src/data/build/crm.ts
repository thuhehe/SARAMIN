      ...
      detail: {
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['Tên hiển thị', 'Yes', 'Text', 'The brand name candidates know. ASKED ON THE COMPANY PAGE TAB, not on the create form — it sits beside the logo it appears with. Readable/editable here too; empty falls back to the legal name everywhere.'],
              ...
              ['Industry', 'Yes', 'Select — Master data', 'Its own field, not joined to size. Also asked on the Company page tab, where it renders in “Company at a glance”; one stored value.'],
              ['Company size (band)', 'DERIVED', 'read-only', 'No longer typed. Derived from `employeeCount`, the exact headcount entered on the Company page tab — storing a band and a number independently guarantees they disagree. The band remains what list filters and facets read.'],
          ...
          items: [
            ...
            'THREE DELIBERATE EXCEPTIONS to that parity: tên hiển thị, industry and headcount are NOT on the create form — they are asked on the Company page tab, beside the things they describe. This is not a data hole because none of them blocks anything: every list falls back to the legal name, and an unset industry only leaves the facts card one row short. Creation asks for the legal name and the MST, the two facts a record cannot exist without.',
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
                        ['Thông tin cơ bản', 'Tags, quốc tịch, tỉnh/thành, website. NOT tên hiển thị / industry / company size — all three moved to the Company page tab, where they sit beside the things they describe.', 'None — the identifying fields are all in the invoice group below'],
        ...
        uiFields: [
          {
            ...
            items: [
              ...
              { name: 'employeeCount', type: 'int', notes: 'ONE exact headcount, entered on the Company page tab. `companySize` (the band 1–49 · 50–200 · 200–500 · 500–1000 · 1000–5000 · 5000+) is DERIVED from it and remains what list filters and facets read — never stored independently, or the two drift.' },
