          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ...
                ['4', 'Pro-rata share, every line but the last', '`alloc_i = round(lump × net_i / sub)`', 'A = round(1.000 × 3.520 / 11.620) = 303'],
                ['5', 'The LAST line takes the remainder', '`alloc_last = lump − Σ alloc_others`', 'B = 1.000 − 303 = **697** (not 697,07)'],
                ['6', 'Invoice thành tiền — an integer', '`invNet_i = net_i − alloc_i`', 'A = 3.217 · B = 7.403'],
                ['7', 'Invoice đơn giá — decimal, presentation only', '`invUnit_i = invNet_i / SL`', 'A = 1.608,50 · B = 2.467,67'],
                ['8', 'Cộng tiền hàng', '`Σ invNet_i` — equals the quotation’s “Sau chiết khấu” to the đồng', '10.620'],
                ['9', 'VAT and total', '`round(Σ invNet × VAT%)`, then add', '850 · **11.470** — the figure the quotation printed'],
              ],
            },
            items: [
              ...
              '**The last line absorbs the rounding.** Pro-rata shares rarely sum to the lump (302,93 + 697,07). Rounding each and giving the last line `lump − Σ others` is what guarantees Σ thành tiền = the quotation’s “Sau chiết khấu” exactly. Which line is “last” must be deterministic — the printed order.',
      ...
      detail: {
        ...
        },
        {
          ...
          items: [
            ...
            'Cộng tiền hàng = Σ thành tiền = the quotation’s “Sau chiết khấu”, to the đồng. VAT is computed once on that sum, not per line and summed — the per-line VAT printed in the provider’s columns 7–9 is presentation and may differ from the total by rounding.',
