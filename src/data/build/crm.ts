        ...
        uiFields: [
          {
            ...
            items: [
              ...
              { name: 'matchResult', type: 'derived (bool)', notes: 'binary + informational: Match (tax code hit an existing company, shows which) · Not match. Never changes the available actions.' },
