...
/* A manual service is BOUGHT — it arrives on a purchase order like any other line,
   so the PO belongs on the entitlement. Without it the card answers "how many posts
   are left" but not "which order paid for them", which is the question asked when a
   customer queries an invoice. */
export type ServiceEntitlement = { sku: string; name: string; unit: string; total: number; validUntil: string; po: string; entries: ServiceDelivery[] }

export const SERVICE_USAGE: Record<string, ServiceEntitlement[]> = {
  'Công ty TNHH Vạn Phát': [
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 4, po: 'PO-005712-07-2026', validUntil: '30/11/2026', entries: [
    ...
    { sku: 'SVC-EMAIL-DEV', name: 'Email Marketing đến Database Developer', unit: 'lượt gửi', total: 1, po: 'PO-005712-07-2026', validUntil: '30/11/2026', entries: [] },
    { sku: 'SVC-JOBALERT', name: 'Big Banner trong Email Job Alert', unit: 'lượt gửi', total: 2, po: 'PO-005712-07-2026', validUntil: '30/11/2026', entries: [
  ...
  'FPT Software': [
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 2, po: 'PO-005929-08-2026', validUntil: '15/09/2026', entries: [
  ...
  'Tiki': [
    { sku: 'SVC-EMAIL-DEV', name: 'Email Marketing đến Database Developer', unit: 'lượt gửi', total: 3, po: 'PO-005604-05-2026', validUntil: '30/06/2026', entries: [
  ...
  'VNG Corporation': [
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 3, po: 'PO-005863-06-2026', validUntil: '20/12/2026', entries: [] },
    { sku: 'SVC-CSKH', name: 'CSKH theo dõi tình hình tuyển dụng', unit: 'mốc', total: 2, po: 'PO-005863-06-2026', validUntil: '20/12/2026', entries: [
  ...
  'MoMo': [
    { sku: 'SVC-JOBALERT', name: 'Big Banner trong Email Job Alert', unit: 'lượt gửi', total: 1, po: 'PO-005918-07-2026', validUntil: '18/10/2026', entries: [] },
  ],
  'Thế Giới Di Động': [
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 6, po: 'PO-005810-05-2026', validUntil: '10/11/2026', entries: [
  ...
  'Công ty TNHH Việt Tiến': [
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 2, po: 'PO-005190-12-2024', validUntil: '10/01/2026', entries: [] },
  ],
  ...
  'Công ty CP Hoàng Gia': [
    ...
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 2, po: 'PO-005733-03-2026', validUntil: '30/06/2026', entries: [] },
    { sku: 'SVC-CSKH', name: 'CSKH theo dõi tình hình tuyển dụng', unit: 'lượt', total: 3, po: 'PO-005733-03-2026', validUntil: '20/12/2026', entries: [
  ...
  'Shopee Việt Nam': [
    { sku: 'SVC-EMAIL-DEV', name: 'Email Marketing đến Database Developer', unit: 'lượt gửi', total: 3, po: 'PO-005881-07-2026', validUntil: '31/10/2026', entries: [
    ...
    { sku: 'SVC-JOBALERT', name: 'Big Banner trong Email Job Alert', unit: 'lượt gửi', total: 2, po: 'PO-005881-07-2026', validUntil: '31/10/2026', entries: [] },
  ],
  'Công ty TNHH Minh Long': [
    // Everything delivered, validity passed — a clean close, nothing owed.
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 1, po: 'PO-005121-12-2025', validUntil: '10/01/2026', entries: [
  ...
  'Công ty CP Trường Sơn': [
    { sku: 'SVC-HACKERRANK', name: 'Đánh giá ứng viên HackerRank', unit: 'bài test', total: 10, po: 'PO-005947-08-2026', validUntil: '30/11/2026', entries: [
    ...
    { sku: 'SVC-CSKH', name: 'CSKH theo dõi tình hình tuyển dụng', unit: 'lượt', total: 2, po: 'PO-005947-08-2026', validUntil: '30/11/2026', entries: [] },
  ],
  'Base.vn': [
    // Small customer, one service, fully used inside validity.
    { sku: 'SVC-EMAIL-DEV', name: 'Email Marketing đến Database Developer', unit: 'lượt gửi', total: 1, po: 'PO-005955-08-2026', validUntil: '30/11/2026', entries: [
  ...
  'Công ty CP An Khang': [
    { sku: 'SVC-JOBALERT', name: 'Big Banner trong Email Job Alert', unit: 'lượt gửi', total: 4, po: 'PO-005902-07-2026', validUntil: '18/10/2026', entries: [
    ...
    { sku: 'SVC-FB-TOPDEV', name: 'Bài đăng Facebook (fanpage TopDev)', unit: 'bài đăng', total: 3, po: 'PO-005902-07-2026', validUntil: '18/10/2026', entries: [] },
  ],
}
