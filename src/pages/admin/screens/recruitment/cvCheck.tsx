...
export function AdminCvCheck() {
  ...
  const raw: CvCheckRow[] = [
    { name: 'Trương Văn Bình', basic: 'Male · 09/09/1998 · Vietnamese · Single · College · 3 yrs exp', contact: ['binh.truong@gmail.com', '0908 551 220'], pref: 'Sales Executive · Sales · Hà Nội · 12–18M · In office', file: 'scan_0816.pdf', kind: 'tech', extracted: 'No readable content — image scan', searchPick: true, apps: 1, ver: 1, sent: 1, sentOld: 0, left: 'sent normally', age: '10m', updated: '10 min ago', hint: 'likely' },
    { name: 'Lâm Thị Kiều', basic: 'Female · 18/05/1999 · Vietnamese · Single · Bachelor · 2 yrs exp', contact: ['kieu.lam@gmail.com', '0899 330 771'], pref: 'UI Designer · Design · Hồ Chí Minh · 15–20M · In office', file: 'CV_2026_final.docx', kind: 'thin', extracted: '2 experience · 1 skill', searchPick: true, apps: 2, ver: 1, sent: 0, sentOld: 0, left: '19h', age: '5h', updated: '5 hours ago', hint: 'likely' },
    { name: 'Hồ Nhật Minh', basic: 'Male · 22/01/1997 · Vietnamese · Single · Bachelor · 4 yrs exp', contact: ['minh.ho@gmail.com', '0906 774 118'], pref: 'Business Analyst · IT · Hồ Chí Minh · 25–35M · Hybrid', file: 'cv-hnm.pdf', kind: 'thin', extracted: '1 experience · 2 skills', apps: 1, ver: 1, sent: 0, sentOld: 0, left: '21h', age: '3h', updated: '3 hours ago', hint: 'likely' },
    ...
    { name: 'Đỗ Thanh Hà', basic: 'Female · 25/12/1996 · Vietnamese · Single · Bachelor · 4 yrs exp', contact: ['ha.do@gmail.com', '0967 004 512'], pref: 'Product Designer · Design · Hồ Chí Minh · 20–30M · Hybrid', file: 'portfolio-2026.pdf', kind: 'thin', extracted: '0 experience · 0 skills', apps: 3, ver: 2, sent: 3, sentOld: 1, left: 'auto-sent', age: '6d', updated: '6 days ago', hint: 'likely' },
    { name: 'Chu Văn Sơn', basic: 'Male · 30/11/1994 · Vietnamese · Married · College · 6 yrs exp', contact: ['son.chu@gmail.com', '0972 118 004'], pref: 'Sales Manager · Sales · Đà Nẵng · 20–30M · In office', file: 'bang-gia-2026.pdf', kind: 'thin', extracted: '0 experience · 0 skills', apps: 1, ver: 1, sent: 1, sentOld: 0, left: 'auto-sent', age: '2d', updated: '2 days ago', hint: 'unlikely' },
    ...
    { name: 'Lý Khánh Vy', basic: 'Female · 17/03/2000 · Vietnamese · Single · Bachelor · 2 yrs exp', contact: ['vy.ly@gmail.com', '0903 887 441'], pref: 'Graphic Designer · Design · Hồ Chí Minh · 15–22M · Hybrid', file: 'CV-KhanhVy-design.pdf', kind: 'thin', extracted: '0 experience · 2 skills', apps: 4, ver: 3, sent: 3, sentOld: 2, left: '11h', age: '13h', updated: '13 hours ago', hint: 'likely' },
    { name: 'Mai Tuấn Kiệt', basic: 'Male · 12/09/1991 · Vietnamese · Married · Master · 9 yrs exp', contact: ['kiet.mai@gmail.com', '0908 330 776'], pref: 'Solution Architect · IT · Hồ Chí Minh · 60–80M · Remote', file: 'cv_scan_2026.pdf', kind: 'tech', extracted: 'No readable content — image scan', apps: 2, ver: 1, sent: 2, sentOld: 0, left: 'sent normally', age: '1d', updated: '1 day ago', hint: 'likely' },
    /* ── resolved: approved by a human ─────────────────────────────────────── */
    { name: 'Bùi Thanh Tùng', basic: 'Male · 02/04/1995 · Vietnamese · Married · Bachelor · 5 yrs exp', contact: ['tung.bui@gmail.com', '0901 447 882'], pref: 'Backend Engineer · IT · Hồ Chí Minh · 35–45M · Hybrid', file: 'tung-cv-scan.pdf', kind: 'tech', extracted: 'No readable content — image scan', apps: 2, ver: 1, sent: 2, sentOld: 0, left: 'sent', age: '—', updated: '1 day ago', hint: 'likely', state: 'approved', by: 'Hà (ops)' },
    ...
    { name: 'Cao Thị Mai', basic: 'Female · 09/12/1996 · Vietnamese · Married · College · 4 yrs exp', contact: ['mai.cao@gmail.com', '0977 441 220'], pref: 'Kế toán tổng hợp · Accounting · Đà Nẵng · 14–18M · In office', file: 'CV_Mai_2cot.pdf', kind: 'thin', extracted: '3 experience · 1 skill', searchPick: true, apps: 4, ver: 2, sent: 4, sentOld: 0, left: 'sent', age: '—', updated: '5 days ago', hint: 'likely', state: 'approved', by: 'Nam (ops)' },
    { name: 'Hoàng Anh Tuấn', basic: 'Male · 18/08/1992 · Vietnamese · Married · Master · 8 yrs exp', contact: ['tuan.hoang@gmail.com', '0912 003 887'], pref: 'Sales Director · Sales · Hà Nội · 50–70M · Hybrid', file: 'tuan-profile.pdf', kind: 'thin', extracted: '4 experience · 9 skills', searchPick: true, apps: 2, left: 'sent', age: '—', updated: '6 days ago', hint: 'likely', state: 'approved', by: 'Hà (ops)', via: 'report' },
    /* more REJECTED cases — every reason code represented, so the view can be
       read as the training set it is meant to be. */
    { name: 'Lương Bảo Ngọc', basic: 'Female · 04/09/1999 · Vietnamese · Single · Bachelor · 2 yrs exp', contact: ['ngoc.luong@gmail.com', '0908 774 003'], pref: 'Marketing Executive · Marketing · Hồ Chí Minh · 18–24M · Hybrid', file: 'ngoc-cv.pdf', kind: 'thin', extracted: '5 experience · 12 skills', apps: 2, ver: 1, sent: 2, sentOld: 0, left: 'recalled', age: '—', updated: '3 days ago', hint: 'likely', state: 'rejected', by: 'Nam (ops)', reason: 'Not a CV', via: 'report' },
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className={cn('rounded-md border px-2 py-1.5 text-[11.5px]', row.kind === 'tech' ? 'border-line bg-canvas/60 text-muted' : 'border-amber-200 bg-amber-50 text-amber-800')}>
                {row.extracted}{row.kind === 'thin'  && ' — below the minimum (≥1 experience, or ≥1 education entry)'}
              </p>
            </div>
            <div>
