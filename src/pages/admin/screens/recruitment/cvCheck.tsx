...
export function AdminCvCheck() {
  ...
  const raw: CvCheckRow[] = [
    { name: 'Trương Văn Bình', basic: 'Male · 09/09/1998 · Vietnamese · Single · College · 3 yrs exp', contact: ['binh.truong@gmail.com', '0908 551 220'], pref: 'Sales Executive · Sales · Hà Nội · 12–18M · In office', file: 'scan_0816.pdf', kind: 'tech', extracted: 'No readable content — image scan', searchPick: true, apps: 1, left: 'sent normally', age: '10m', updated: '10 min ago', hint: 'likely' },
    { name: 'Lâm Thị Kiều', basic: 'Female · 18/05/1999 · Vietnamese · Single · Bachelor · 2 yrs exp', contact: ['kieu.lam@gmail.com', '0899 330 771'], pref: 'UI Designer · Design · Hồ Chí Minh · 15–20M · In office', file: 'CV_2026_final.docx', kind: 'thin', extracted: '2 experience · 1 skill', searchPick: true, apps: 2, left: '19h', age: '5h', updated: '5 hours ago', hint: 'likely' },
    ...
    { name: 'Cao Thị Mai', basic: 'Female · 09/12/1996 · Vietnamese · Married · College · 4 yrs exp', contact: ['mai.cao@gmail.com', '0977 441 220'], pref: 'Kế toán tổng hợp · Accounting · Đà Nẵng · 14–18M · In office', file: 'CV_Mai_2cot.pdf', kind: 'thin', extracted: '3 experience · 1 skill', searchPick: true, apps: 4, left: 'sent', age: '—', updated: '5 days ago', hint: 'likely', state: 'approved', by: 'Nam (ops)' },
